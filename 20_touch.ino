...
<link crossorigin="anonymous" media="all" rel="stylesheet" href="https://github.githubassets.com/assets/react-code-view.ab7d8fac328c00e5e0cc.module.css" />
  ...
  <title>ESP32/20_touch.ino at main · 32ES/ESP32</title>
  ...
  <meta name="request-id" content="0701:376587:69A88:DEE9B:67CA0A1D" data-turbo-transient="true" /><meta name="html-safe-nonce" content="d9831b25491ef5c020d3355ef288eaa25406e60d4633e021b9f42aff64a97bf0" data-turbo-transient="true" /><meta name="visitor-payload" content="eyJyZWZlcnJlciI6Imh0dHBzOi8vZ2l0aHViLmNvbS8zMkVTL0VTUDMyIiwicmVxdWVzdF9pZCI6IjA3MDE6Mzc2NTg3OjY5QTg4OkRFRTlCOjY3Q0EwQTFEIiwidmlzaXRvcl9pZCI6IjY2NjEyMDIzMDU5NTE0MzQ2MDQiLCJyZWdpb25fZWRnZSI6ImlzcmFlbGNlbnRyYWwiLCJyZWdpb25fcmVuZGVyIjoiaWFkIn0=" data-turbo-transient="true" /><meta name="visitor-hmac" content="8152cf594a265d0db20bf8a1352c48a1a5219b675eaba56b6e3159f03093c0ce" data-turbo-transient="true" />
...
<meta name="octolytics-url" content="https://collector.github.com/github/collect" /><meta name="octolytics-actor-id" content="190653694" /><meta name="octolytics-actor-login" content="32ES" /><meta name="octolytics-actor-hash" content="6e23f7da5969f1eb89aff2cd86650b5454e97ff5fc904b7450ae67566cbbe58c" />
  ...
  <link rel="sudo-modal" href="/sessions/sudo_modal">
    ...
    <meta name="apple-itunes-app" content="app-id=1477376905, app-argument=https://github.com/32ES/ESP32/blob/main/20_touch.ino" />

      <meta name="twitter:image" content="https://opengraph.githubassets.com/df7cefd32a3f81f8dd0e99a09b92ab71823f7a84d235f023bd76497c4d239c09/32ES/ESP32" /><meta name="twitter:site" content="@github" /><meta name="twitter:card" content="summary_large_image" /><meta name="twitter:title" content="ESP32/20_touch.ino at main · 32ES/ESP32" /><meta name="twitter:description" content="Contribute to 32ES/ESP32 development by creating an account on GitHub." />
  <meta property="og:image" content="https://opengraph.githubassets.com/df7cefd32a3f81f8dd0e99a09b92ab71823f7a84d235f023bd76497c4d239c09/32ES/ESP32" /><meta property="og:image:alt" content="Contribute to 32ES/ESP32 development by creating an account on GitHub." /><meta property="og:image:width" content="1200" /><meta property="og:image:height" content="600" /><meta property="og:site_name" content="GitHub" /><meta property="og:type" content="object" /><meta property="og:title" content="ESP32/20_touch.ino at main · 32ES/ESP32" /><meta property="og:url" content="https://github.com/32ES/ESP32/blob/main/20_touch.ino" /><meta property="og:description" content="Contribute to 32ES/ESP32 development by creating an account on GitHub." />
  


      <link rel="shared-web-socket" href="wss://alive.github.com/_sockets/u/190653694/ws?session=eyJ2IjoiVjMiLCJ1IjoxOTA2NTM2OTQsInMiOjE1OTk2Njc1MDMsImMiOjEzNDM0NDc2MzMsInQiOjE3NDEyOTQxMTR9--893d4d13a174aea4b554765ec36779e151771f8169e4c1a5bed51a30ae346a46" data-refresh-url="/_alive" data-session-id="c1fb51bc7de77b54343da3cb1b5990c000bf0b6edcac44cf8a54715cb7924a35">
...
>
  ...
  <include-fragment data-target="deferred-side-panel.fragment">
      <button aria-label="Open global navigation menu" data-action="click:deferred-side-panel#loadPanel click:deferred-side-panel#panelOpened" data-show-dialog-id="dialog-1873b71e-127a-45eb-abf1-c32abf825053" id="dialog-show-dialog-1873b71e-127a-45eb-abf1-c32abf825053" type="button" data-view-component="true" class="Button Button--iconOnly Button--secondary Button--medium AppHeader-button p-0 color-fg-muted">  <svg aria-hidden="true" height="16" viewBox="0 0 16 16" version="1.1" width="16" data-view-component="true" class="octicon octicon-three-bars Button-visual">
    <path d="M1 2.75A.75.75 0 0 1 1.75 2h12.5a.75.75 0 0 1 0 1.5H1.75A.75.75 0 0 1 1 2.75Zm0 5A.75.75 0 0 1 1.75 7h12.5a.75.75 0 0 1 0 1.5H1.75A.75.75 0 0 1 1 7.75ZM1.75 12h12.5a.75.75 0 0 1 0 1.5H1.75a.75.75 0 0 1 0-1.5Z"></path>
</svg>
</button>

<dialog-helper>
  <dialog data-target="deferred-side-panel.panel" id="dialog-1873b71e-127a-45eb-abf1-c32abf825053" aria-modal="true" aria-labelledby="dialog-1873b71e-127a-45eb-abf1-c32abf825053-title" aria-describedby="dialog-1873b71e-127a-45eb-abf1-c32abf825053-description" data-view-component="true" class="Overlay Overlay-whenNarrow Overlay--size-small-portrait Overlay--motion-scaleFade Overlay--placement-left SidePanel Overlay--disableScroll">
    <div styles="flex-direction: row;" data-view-component="true" class="Overlay-header">
  <div class="Overlay-headerContentWrap">
    <div class="Overlay-titleWrap">
      <h1 class="Overlay-title sr-only" id="dialog-1873b71e-127a-45eb-abf1-c32abf825053-title">
        Global navigation
      </h1>
    ...
    <div class="Overlay-actionWrap">
      <button data-close-dialog-id="dialog-1873b71e-127a-45eb-abf1-c32abf825053" aria-label="Close" type="button" data-view-component="true" class="close-button Overlay-closeButton"><svg aria-hidden="true" height="16" viewBox="0 0 16 16" version="1.1" width="16" data-view-component="true" class="octicon octicon-x">
    <path d="M3.72 3.72a.75.75 0 0 1 1.06 0L8 6.94l3.22-3.22a.749.749 0 0 1 1.275.326.749.749 0 0 1-.215.734L9.06 8l3.22 3.22a.749.749 0 0 1-.326 1.275.749.749 0 0 1-.734-.215L8 9.06l-3.22 3.22a.751.751 0 0 1-1.042-.018.751.751 0 0 1-.018-1.042L6.94 8 3.72 4.78a.75.75 0 0 1 0-1.06Z"></path>
      ...
      <scrollable-region data-labelled-by="dialog-1873b71e-127a-45eb-abf1-c32abf825053-title">
...
<li data-item-id="" data-targets="nav-list.items" data-view-component="true" class="ActionListItem">
    ...
    <a data-hotkey="g d" data-analytics-event="{&quot;category&quot;:&quot;Global navigation&quot;,&quot;action&quot;:&quot;HOME&quot;,&quot;label&quot;:null}" id="item-6b07a62c-6dea-480b-9085-896ac856e647" href="/dashboard" data-view-component="true" class="ActionListContent ActionListContent--visual16">
...
<li data-item-id="" data-targets="nav-list.items" data-view-component="true" class="ActionListItem">
    ...
    <a data-hotkey="g i" data-analytics-event="{&quot;category&quot;:&quot;Global navigation&quot;,&quot;action&quot;:&quot;ISSUES&quot;,&quot;label&quot;:null}" id="item-b493a946-be7f-4c35-a9ac-6794d30e79d1" href="/issues" data-view-component="true" class="ActionListContent ActionListContent--visual16">
        <span class="ActionListItem-visual ActionListItem-visual--leading">
...
<li data-item-id="" data-targets="nav-list.items" data-view-component="true" class="ActionListItem">
    ...
    <a data-hotkey="g p" data-analytics-event="{&quot;category&quot;:&quot;Global navigation&quot;,&quot;action&quot;:&quot;PULL_REQUESTS&quot;,&quot;label&quot;:null}" id="item-a383484b-69b1-43b8-a78c-8389b0b5bb72" href="/pulls" data-view-component="true" class="ActionListContent ActionListContent--visual16">
        <span class="ActionListItem-visual ActionListItem-visual--leading">
...
<li data-item-id="" data-targets="nav-list.items" data-item-id="projects" data-view-component="true" class="ActionListItem">
    ...
    <a data-analytics-event="{&quot;category&quot;:&quot;Global navigation&quot;,&quot;action&quot;:&quot;PROJECTS&quot;,&quot;label&quot;:null}" id="item-7e70041a-b303-4ac5-b828-1adc7a227c22" href="/projects" data-view-component="true" class="ActionListContent ActionListContent--visual16">
        <span class="ActionListItem-visual ActionListItem-visual--leading">
...
<li data-item-id="" data-targets="nav-list.items" data-view-component="true" class="ActionListItem">
    ...
    <a data-analytics-event="{&quot;category&quot;:&quot;Global navigation&quot;,&quot;action&quot;:&quot;DISCUSSIONS&quot;,&quot;label&quot;:null}" id="item-af9190dc-22f4-427f-8aac-a096b6c3c3c5" href="/discussions" data-view-component="true" class="ActionListContent ActionListContent--visual16">
        <span class="ActionListItem-visual ActionListItem-visual--leading">
...
<li data-item-id="" data-targets="nav-list.items" data-view-component="true" class="ActionListItem">
    ...
    <a data-analytics-event="{&quot;category&quot;:&quot;Global navigation&quot;,&quot;action&quot;:&quot;CODESPACES&quot;,&quot;label&quot;:null}" id="item-8caeebae-ff69-413b-b7fd-2955cedbb26d" href="https://github.com/codespaces" data-view-component="true" class="ActionListContent ActionListContent--visual16">
        <span class="ActionListItem-visual ActionListItem-visual--leading">
...
<li data-item-id="" data-targets="nav-list.items" data-view-component="true" class="ActionListItem">
    ...
    <a data-analytics-event="{&quot;category&quot;:&quot;Global navigation&quot;,&quot;action&quot;:&quot;COPILOT&quot;,&quot;label&quot;:null}" id="item-a9611b32-7b06-4189-8d5d-8a14e4dad8de" href="/copilot" data-view-component="true" class="ActionListContent ActionListContent--visual16">
        <span class="ActionListItem-visual ActionListItem-visual--leading">
...
<li data-item-id="" data-targets="nav-list.items" data-view-component="true" class="ActionListItem">
    ...
    <a data-analytics-event="{&quot;category&quot;:&quot;Global navigation&quot;,&quot;action&quot;:&quot;EXPLORE&quot;,&quot;label&quot;:null}" id="item-503b99bf-346b-4dd8-b342-f162559eaec5" href="/explore" data-view-component="true" class="ActionListContent ActionListContent--visual16">
        <span class="ActionListItem-visual ActionListItem-visual--leading">
...
<li data-item-id="" data-targets="nav-list.items" data-view-component="true" class="ActionListItem">
    ...
    <a data-analytics-event="{&quot;category&quot;:&quot;Global navigation&quot;,&quot;action&quot;:&quot;MARKETPLACE&quot;,&quot;label&quot;:null}" id="item-d8118f49-75a1-4c01-9317-7c09a1ac234d" href="/marketplace" data-view-component="true" class="ActionListContent ActionListContent--visual16">
        <span class="ActionListItem-visual ActionListItem-visual--leading">
...
<qbsearch-input class="search-input" data-scope="repo:32ES/ESP32" data-custom-scopes-path="/search/custom_scopes" data-delete-custom-scopes-csrf="6zMNwnD3bOWn8xo48vaJYESkExoof2DdY8bkGblJB_o0b5C0dcGsL-9K8U8FiTwPuDmSh1fKhli8Mb1EhDzDnQ" data-max-custom-scopes="10" data-header-redesign-enabled="true" data-initial-value="" data-blackbird-suggestions-path="/search/suggestions" data-jump-to-suggestions-path="/_graphql/GetSuggestedNavigationDestinations" data-current-repository="32ES/ESP32" data-current-org="" data-current-owner="32ES" data-logged-in="true" data-copilot-chat-enabled="false" data-nl-search-enabled="false">
  <div
    ...
    <path d="M10.68 11.74a6 6 0 0 1-7.922-8.982 6 6 0 0 1 8.982 7.922l3.04 3.04a.749.749 0 0 1-.326 1.275.749.749 0 0 1-.734-.215ZM11.5 7a4.499 4.499 0 1 0-8.997 0A4.499 4.499 0 0 0 11.5 7Z"></path>
        ...
        <div data-target="query-builder.styledInputContainer" class="QueryBuilder-StyledInputContainer">
          ...
          <div class="QueryBuilder-InputWrapper">
            ...
            <input id="query-builder-test" name="query-builder-test" value="" autocomplete="off" type="text" role="combobox" spellcheck="false" aria-expanded="false" aria-describedby="validation-97ffff50-820a-434e-bf3d-4d0478a44291" data-target="query-builder.input" data-action="
...
<template id="device-desktop-icon">
  <svg aria-hidden="true" height="16" viewBox="0 0 16 16" version="1.1" width="16" data-view-component="true" class="octicon octicon-device-desktop">
    <path d="M14.25 1c.966 0 1.75.784 1.75 1.75v7.5A1.75 1.75 0 0 1 14.25 12h-3.727c.099 1.041.52 1.872 1.292 2.757A.752.752 0 0 1 11.25 16h-6.5a.75.75 0 0 1-.565-1.243c.772-.885 1.192-1.716 1.292-2.757H1.75A1.75 1.75 0 0 1 0 10.25v-7.5C0 1.784.784 1 1.75 1ZM1.75 2.5a.25.25 0 0 0-.25.25v7.5c0 .138.112.25.25.25h12.5a.25.25 0 0 0 .25-.25v-7.5a.25.25 0 0 0-.25-.25ZM9.018 12H6.982a5.72 5.72 0 0 1-.765 2.5h3.566a5.72 5.72 0 0 1-.765-2.5Z"></path>
      ...
      <div class="FormControl-inlineValidation" id="validation-97ffff50-820a-434e-bf3d-4d0478a44291" hidden="hidden">
  ...
  <div class="Overlay-headerContentWrap">
    ...
    <path d="M3.72 3.72a.75.75 0 0 1 1.06 0L8 6.94l3.22-3.22a.749.749 0 0 1 1.275.326.749.749 0 0 1-.215.734L9.06 8l3.22 3.22a.749.749 0 0 1-.326 1.275.749.749 0 0 1-.734-.215L8 9.06l-3.22 3.22a.751.751 0 0 1-1.042-.018.751.751 0 0 1-.018-1.042L6.94 8 3.72 4.78a.75.75 0 0 1 0-1.06Z"></path>
      ...
      <scrollable-region data-labelled-by="feedback-dialog-title">
        <div data-view-component="true" class="Overlay-body">        <!-- '"` --><!-- </textarea></xmp> --></option></form><form id="code-search-feedback-form" data-turbo="false" action="/search/feedback" accept-charset="UTF-8" method="post"><input type="hidden" name="authenticity_token" value="3TmX4DfiU46mygRAvszn9PLf_QcQ6L0zGtxtnuviFoTRtvUI5dCWV6en1tflV97-9VfWxxAzMiwx1lu49uUVEA" />
  ...
  <div class="Overlay-headerContentWrap">
    ...
    <path d="M3.72 3.72a.75.75 0 0 1 1.06 0L8 6.94l3.22-3.22a.749.749 0 0 1 1.275.326.749.749 0 0 1-.215.734L9.06 8l3.22 3.22a.749.749 0 0 1-.326 1.275.749.749 0 0 1-.734-.215L8 9.06l-3.22 3.22a.751.751 0 0 1-1.042-.018.751.751 0 0 1-.018-1.042L6.94 8 3.72 4.78a.75.75 0 0 1 0-1.06Z"></path>
      ...
      <scrollable-region data-labelled-by="custom-scopes-dialog-title">
        ...
        <!-- '"` --><!-- </textarea></xmp> --></option></form><form id="custom-scopes-dialog-form" data-turbo="false" action="/search/custom_scopes" accept-charset="UTF-8" method="post"><input type="hidden" name="authenticity_token" value="G2z6RM8SZXc5wxbGsGydRBc_u5gHl21CkaWtInFjahAceYQcmRqqqVQj2YWjRrN1jGm4cupiHRH5OqvxagHpTw" />
          ...
          <div class="form-group">
            ...
            <auto-check src="/search/custom_scopes/check_name" required only-validate-on-blur="false">
              <input
                ...
                required
                maxlength="50">
              <input type="hidden" value="0DCG2PKx7TTsyjNE5taMHd90Q5TQBsax8-xFVVL9KqNBfLyVOn8FcEFskZIR3pWmbJEozAeA_fMfXc4lhnSc6A" data-csrf="true" />
            </auto-check>
          </div>
...
</qbsearch-input>  <input type="hidden" value="qOFPjHikyt8B345hbm_TeMk-0-Gqhv1B-hEOBOcCHK5jFcjSAfLR8QRZcntenrny-1O-uU4qG-zacHi9EmICwA" data-csrf="true" class="js-data-jump-to-suggestions-path-csrf" />
    ...
    <react-partial-anchor>
      <button id="copilot-chat-header-button" data-target="react-partial-anchor.anchor" data-hotkey="Shift+C" aria-expanded="false" aria-controls="copilot-chat-panel" aria-labelledby="tooltip-9e4ffe12-b795-4ecf-a8b9-d47eedc7a2eb" type="button" disabled="disabled" data-view-component="true" class="Button Button--iconOnly Button--secondary Button--medium AppHeader-button AppHeader-buttonLeft cursor-wait">  <svg aria-hidden="true" height="16" viewBox="0 0 16 16" version="1.1" width="16" data-view-component="true" class="octicon octicon-copilot Button-visual">
    <path d="M7.998 15.035c-4.562 0-7.873-2.914-7.998-3.749V9.338c.085-.628.677-1.686 1.588-2.065.013-.07.024-.143.036-.218.029-.183.06-.384.126-.612-.201-.508-.254-1.084-.254-1.656 0-.87.128-1.769.693-2.484.579-.733 1.494-1.124 2.724-1.261 1.206-.134 2.262.034 2.944.765.05.053.096.108.139.165.044-.057.094-.112.143-.165.682-.731 1.738-.899 2.944-.765 1.23.137 2.145.528 2.724 1.261.566.715.693 1.614.693 2.484 0 .572-.053 1.148-.254 1.656.066.228.098.429.126.612.012.076.024.148.037.218.924.385 1.522 1.471 1.591 2.095v1.872c0 .766-3.351 3.795-8.002 3.795Zm0-1.485c2.28 0 4.584-1.11 5.002-1.433V7.862l-.023-.116c-.49.21-1.075.291-1.727.291-1.146 0-2.059-.327-2.71-.991A3.222 3.222 0 0 1 8 6.303a3.24 3.24 0 0 1-.544.743c-.65.664-1.563.991-2.71.991-.652 0-1.236-.081-1.727-.291l-.023.116v4.255c.419.323 2.722 1.433 5.002 1.433ZM6.762 2.83c-.193-.206-.637-.413-1.682-.297-1.019.113-1.479.404-1.713.7-.247.312-.369.789-.369 1.554 0 .793.129 1.171.308 1.371.162.181.519.379 1.442.379.853 0 1.339-.235 1.638-.54.315-.322.527-.827.617-1.553.117-.935-.037-1.395-.241-1.614Zm4.155-.297c-1.044-.116-1.488.091-1.681.297-.204.219-.359.679-.242 1.614.091.726.303 1.231.618 1.553.299.305.784.54 1.638.54.922 0 1.28-.198 1.442-.379.179-.2.308-.578.308-1.371 0-.765-.123-1.242-.37-1.554-.233-.296-.693-.587-1.713-.7Z"></path><path d="M6.25 9.037a.75.75 0 0 1 .75.75v1.501a.75.75 0 0 1-1.5 0V9.787a.75.75 0 0 1 .75-.75Zm4.25.75v1.501a.75.75 0 0 1-1.5 0V9.787a.75.75 0 0 1 1.5 0Z"></path>
</svg>
</button><tool-tip id="tooltip-9e4ffe12-b795-4ecf-a8b9-d47eedc7a2eb" for="copilot-chat-header-button" popover="manual" data-direction="s" data-type="label" data-view-component="true" class="sr-only position-absolute">Chat with Copilot</tool-tip>
...
<link crossorigin="anonymous" media="all" rel="stylesheet" href="https://github.githubassets.com/assets/copilot-chat.4e64150ee8c92ed63ef0.module.css" />
    ...
    <react-partial-anchor>
      <button id="global-copilot-menu-button" data-target="react-partial-anchor.anchor" aria-expanded="false" aria-labelledby="tooltip-31c6a581-1d22-424e-aaf9-7609e1ad59c3" type="button" data-view-component="true" class="Button Button--iconOnly Button--secondary Button--medium AppHeader-button AppHeader-buttonRight">  <svg aria-hidden="true" height="16" viewBox="0 0 16 16" version="1.1" width="16" data-view-component="true" class="octicon octicon-triangle-down Button-visual">
    <path d="m4.427 7.427 3.396 3.396a.25.25 0 0 0 .354 0l3.396-3.396A.25.25 0 0 0 11.396 7H4.604a.25.25 0 0 0-.177.427Z"></path>
</svg>
</button><tool-tip id="tooltip-31c6a581-1d22-424e-aaf9-7609e1ad59c3" for="global-copilot-menu-button" popover="manual" data-direction="s" data-type="label" data-view-component="true" class="sr-only position-absolute">Open Copilot…</tool-tip>
...
</button><tool-tip id="tooltip-88d83374-eb5e-461b-9197-7db03f17a2ed" for="global-create-menu-anchor" popover="manual" data-direction="s" data-type="description" data-view-component="true" class="sr-only position-absolute">Create new...</tool-tip>
...
>
  ...
  <div data-target="react-partial.reactRoot"></div>
          ...
          <a href="/issues" data-analytics-event="{&quot;category&quot;:&quot;Global navigation&quot;,&quot;action&quot;:&quot;ISSUES_HEADER&quot;,&quot;label&quot;:null}" id="icon-button-02688f29-d5e0-4052-b417-b7e88c3c04fa" aria-labelledby="tooltip-b7ccfb44-eeff-4199-873a-587072d60fd4" data-view-component="true" class="Button Button--iconOnly Button--secondary Button--medium AppHeader-button color-fg-muted">  <svg aria-hidden="true" height="16" viewBox="0 0 16 16" version="1.1" width="16" data-view-component="true" class="octicon octicon-issue-opened Button-visual">
    <path d="M8 9.5a1.5 1.5 0 1 0 0-3 1.5 1.5 0 0 0 0 3Z"></path><path d="M8 0a8 8 0 1 1 0 16A8 8 0 0 1 8 0ZM1.5 8a6.5 6.5 0 1 0 13 0 6.5 6.5 0 0 0-13 0Z"></path>
</svg>
</a><tool-tip id="tooltip-b7ccfb44-eeff-4199-873a-587072d60fd4" for="icon-button-02688f29-d5e0-4052-b417-b7e88c3c04fa" popover="manual" data-direction="s" data-type="label" data-view-component="true" class="sr-only position-absolute">Your issues</tool-tip>

          <a href="/pulls" data-analytics-event="{&quot;category&quot;:&quot;Global navigation&quot;,&quot;action&quot;:&quot;PULL_REQUESTS_HEADER&quot;,&quot;label&quot;:null}" id="icon-button-59f714fb-ac41-4fb0-83a0-cf4f0f15a638" aria-labelledby="tooltip-5e0d61e4-029f-4c4f-b959-c434a2fd9d0a" data-view-component="true" class="Button Button--iconOnly Button--secondary Button--medium AppHeader-button color-fg-muted">  <svg aria-hidden="true" height="16" viewBox="0 0 16 16" version="1.1" width="16" data-view-component="true" class="octicon octicon-git-pull-request Button-visual">
    <path d="M1.5 3.25a2.25 2.25 0 1 1 3 2.122v5.256a2.251 2.251 0 1 1-1.5 0V5.372A2.25 2.25 0 0 1 1.5 3.25Zm5.677-.177L9.573.677A.25.25 0 0 1 10 .854V2.5h1A2.5 2.5 0 0 1 13.5 5v5.628a2.251 2.251 0 1 1-1.5 0V5a1 1 0 0 0-1-1h-1v1.646a.25.25 0 0 1-.427.177L7.177 3.427a.25.25 0 0 1 0-.354ZM3.75 2.5a.75.75 0 1 0 0 1.5.75.75 0 0 0 0-1.5Zm0 9.5a.75.75 0 1 0 0 1.5.75.75 0 0 0 0-1.5Zm8.25.75a.75.75 0 1 0 1.5 0 .75.75 0 0 0-1.5 0Z"></path>
</svg>
</a><tool-tip id="tooltip-5e0d61e4-029f-4c4f-b959-c434a2fd9d0a" for="icon-button-59f714fb-ac41-4fb0-83a0-cf4f0f15a638" popover="manual" data-direction="s" data-type="label" data-view-component="true" class="sr-only position-absolute">Your pull requests</tool-tip>

        </div>

        <notification-indicator data-channel="eyJjIjoibm90aWZpY2F0aW9uLWNoYW5nZWQ6MTkwNjUzNjk0IiwidCI6MTc0MTI5NDExNH0=--c9a058b32e8019250e6eedf8126d975efe1671f464ed32dadd10376a70f9ef52" data-indicator-mode="none" data-tooltip-global="You have unread notifications" data-tooltip-unavailable="Notifications are unavailable at the moment." data-tooltip-none="You have no unread notifications" data-header-redesign-enabled="true" data-fetch-indicator-src="/notifications/indicator" data-fetch-indicator-enabled="true" data-view-component="true" class="js-socket-channel">
...
<site-header-logged-in-user-menu>
  ...
  <focus-group direction="vertical" mnemonics retain>
    <button id="action-menu-ed92c1e4-9269-4004-babb-05448f6d43f5-button" popovertarget="action-menu-ed92c1e4-9269-4004-babb-05448f6d43f5-overlay" aria-controls="action-menu-ed92c1e4-9269-4004-babb-05448f6d43f5-list" aria-haspopup="true" aria-labelledby="tooltip-c8092f5b-5084-4ec9-b2d3-57c27f708589" type="button" data-view-component="true" class="Button Button--iconOnly Button--secondary Button--medium UnderlineNav-item">  <svg aria-hidden="true" height="16" viewBox="0 0 16 16" version="1.1" width="16" data-view-component="true" class="octicon octicon-kebab-horizontal Button-visual">
    <path d="M8 9a1.5 1.5 0 1 0 0-3 1.5 1.5 0 0 0 0 3ZM1.5 9a1.5 1.5 0 1 0 0-3 1.5 1.5 0 0 0 0 3Zm13 0a1.5 1.5 0 1 0 0-3 1.5 1.5 0 0 0 0 3Z"></path>
</svg>
</button><tool-tip id="tooltip-c8092f5b-5084-4ec9-b2d3-57c27f708589" for="action-menu-ed92c1e4-9269-4004-babb-05448f6d43f5-button" popover="manual" data-direction="s" data-type="label" data-view-component="true" class="sr-only position-absolute">Additional navigation options</tool-tip>


<anchored-position data-target="action-menu.overlay" id="action-menu-ed92c1e4-9269-4004-babb-05448f6d43f5-overlay" anchor="action-menu-ed92c1e4-9269-4004-babb-05448f6d43f5-button" align="start" side="outside-bottom" anchor-offset="normal" popover="auto" data-view-component="true">
  <div data-view-component="true" class="Overlay Overlay--size-auto">
    
      <div data-view-component="true" class="Overlay-body Overlay-body--paddingNone">          <action-list>
  <div data-view-component="true">
    <ul aria-labelledby="action-menu-ed92c1e4-9269-4004-babb-05448f6d43f5-button" id="action-menu-ed92c1e4-9269-4004-babb-05448f6d43f5-list" role="menu" data-view-component="true" class="ActionListWrap--inset ActionListWrap">
        <li hidden="hidden" data-menu-item="i0code-tab" data-targets="action-list.items" role="none" data-view-component="true" class="ActionListItem">
    
    
    <a tabindex="-1" id="item-181d6392-546e-49d4-952e-969840a3ddbc" href="/32ES/ESP32" role="menuitem" data-view-component="true" class="ActionListContent ActionListContent--visual16">
        <span class="ActionListItem-visual ActionListItem-visual--leading">
          <svg aria-hidden="true" height="16" viewBox="0 0 16 16" version="1.1" width="16" data-view-component="true" class="octicon octicon-code">
    <path d="m11.28 3.22 4.25 4.25a.75.75 0 0 1 0 1.06l-4.25 4.25a.749.749 0 0 1-1.275-.326.749.749 0 0 1 .215-.734L13.94 8l-3.72-3.72a.749.749 0 0 1 .326-1.275.749.749 0 0 1 .734.215Zm-6.56 0a.751.751 0 0 1 1.042.018.751.751 0 0 1 .018 1.042L2.06 8l3.72 3.72a.749.749 0 0 1-.326 1.275.749.749 0 0 1-.734-.215L.47 8.53a.75.75 0 0 1 0-1.06Z"></path>
</svg>
    ...
    <a tabindex="-1" id="item-f15329d3-fafa-4472-9da7-227e7b81a742" href="/32ES/ESP32/issues" role="menuitem" data-view-component="true" class="ActionListContent ActionListContent--visual16">
        <span class="ActionListItem-visual ActionListItem-visual--leading">
          <svg aria-hidden="true" height="16" viewBox="0 0 16 16" version="1.1" width="16" data-view-component="true" class="octicon octicon-issue-opened">
    <path d="M8 9.5a1.5 1.5 0 1 0 0-3 1.5 1.5 0 0 0 0 3Z"></path><path d="M8 0a8 8 0 1 1 0 16A8 8 0 0 1 8 0ZM1.5 8a6.5 6.5 0 1 0 13 0 6.5 6.5 0 0 0-13 0Z"></path>
</svg>
    ...
    <a tabindex="-1" id="item-f8bfae4f-0d6e-4e35-8a72-f4bdc9d1a653" href="/32ES/ESP32/pulls" role="menuitem" data-view-component="true" class="ActionListContent ActionListContent--visual16">
        <span class="ActionListItem-visual ActionListItem-visual--leading">
          <svg aria-hidden="true" height="16" viewBox="0 0 16 16" version="1.1" width="16" data-view-component="true" class="octicon octicon-git-pull-request">
    <path d="M1.5 3.25a2.25 2.25 0 1 1 3 2.122v5.256a2.251 2.251 0 1 1-1.5 0V5.372A2.25 2.25 0 0 1 1.5 3.25Zm5.677-.177L9.573.677A.25.25 0 0 1 10 .854V2.5h1A2.5 2.5 0 0 1 13.5 5v5.628a2.251 2.251 0 1 1-1.5 0V5a1 1 0 0 0-1-1h-1v1.646a.25.25 0 0 1-.427.177L7.177 3.427a.25.25 0 0 1 0-.354ZM3.75 2.5a.75.75 0 1 0 0 1.5.75.75 0 0 0 0-1.5Zm0 9.5a.75.75 0 1 0 0 1.5.75.75 0 0 0 0-1.5Zm8.25.75a.75.75 0 1 0 1.5 0 .75.75 0 0 0-1.5 0Z"></path>
</svg>
    ...
    <a tabindex="-1" id="item-f85d24c1-c5ad-497b-bb28-f85f5fa24e58" href="/32ES/ESP32/actions" role="menuitem" data-view-component="true" class="ActionListContent ActionListContent--visual16">
        <span class="ActionListItem-visual ActionListItem-visual--leading">
          <svg aria-hidden="true" height="16" viewBox="0 0 16 16" version="1.1" width="16" data-view-component="true" class="octicon octicon-play">
    <path d="M8 0a8 8 0 1 1 0 16A8 8 0 0 1 8 0ZM1.5 8a6.5 6.5 0 1 0 13 0 6.5 6.5 0 0 0-13 0Zm4.879-2.773 4.264 2.559a.25.25 0 0 1 0 .428l-4.264 2.559A.25.25 0 0 1 6 10.559V5.442a.25.25 0 0 1 .379-.215Z"></path>
</svg>
    ...
    <a tabindex="-1" id="item-00221d81-fb1a-4c40-af16-2fb5a63f7895" href="/32ES/ESP32/projects" role="menuitem" data-view-component="true" class="ActionListContent ActionListContent--visual16">
        <span class="ActionListItem-visual ActionListItem-visual--leading">
          <svg aria-hidden="true" height="16" viewBox="0 0 16 16" version="1.1" width="16" data-view-component="true" class="octicon octicon-table">
    <path d="M0 1.75C0 .784.784 0 1.75 0h12.5C15.216 0 16 .784 16 1.75v12.5A1.75 1.75 0 0 1 14.25 16H1.75A1.75 1.75 0 0 1 0 14.25ZM6.5 6.5v8h7.75a.25.25 0 0 0 .25-.25V6.5Zm8-1.5V1.75a.25.25 0 0 0-.25-.25H6.5V5Zm-13 1.5v7.75c0 .138.112.25.25.25H5v-8ZM5 5V1.5H1.75a.25.25 0 0 0-.25.25V5Z"></path>
</svg>
    ...
    <a tabindex="-1" id="item-bc50accc-24d7-4c61-ab61-6eeafef4bec1" href="/32ES/ESP32/wiki" role="menuitem" data-view-component="true" class="ActionListContent ActionListContent--visual16">
        <span class="ActionListItem-visual ActionListItem-visual--leading">
          <svg aria-hidden="true" height="16" viewBox="0 0 16 16" version="1.1" width="16" data-view-component="true" class="octicon octicon-book">
    <path d="M0 1.75A.75.75 0 0 1 .75 1h4.253c1.227 0 2.317.59 3 1.501A3.743 3.743 0 0 1 11.006 1h4.245a.75.75 0 0 1 .75.75v10.5a.75.75 0 0 1-.75.75h-4.507a2.25 2.25 0 0 0-1.591.659l-.622.621a.75.75 0 0 1-1.06 0l-.622-.621A2.25 2.25 0 0 0 5.258 13H.75a.75.75 0 0 1-.75-.75Zm7.251 10.324.004-5.073-.002-2.253A2.25 2.25 0 0 0 5.003 2.5H1.5v9h3.757a3.75 3.75 0 0 1 1.994.574ZM8.755 4.75l-.004 7.322a3.752 3.752 0 0 1 1.992-.572H14.5v-9h-3.495a2.25 2.25 0 0 0-2.25 2.25Z"></path>
</svg>
    ...
    <a tabindex="-1" id="item-b80284d5-28f7-471f-b9bd-e7fc4f869770" href="/32ES/ESP32/security" role="menuitem" data-view-component="true" class="ActionListContent ActionListContent--visual16">
        <span class="ActionListItem-visual ActionListItem-visual--leading">
    ...
    <a tabindex="-1" id="item-112311e6-2fa2-4993-922a-2df24d662f39" href="/32ES/ESP32/pulse" role="menuitem" data-view-component="true" class="ActionListContent ActionListContent--visual16">
        <span class="ActionListItem-visual ActionListItem-visual--leading">
    ...
    <a tabindex="-1" id="item-d583f1da-f39a-45b9-9d76-0fe361a9618e" href="/32ES/ESP32/settings" role="menuitem" data-view-component="true" class="ActionListContent ActionListContent--visual16">
        <span class="ActionListItem-visual ActionListItem-visual--leading">
    ...
    <button id="icon-button-67c69b8b-ed89-469f-85e9-7410fae1569a" aria-labelledby="tooltip-fdecd9f3-992c-41b9-b813-6c197745d411" type="button" data-view-component="true" class="Button Button--iconOnly Button--invisible Button--medium flash-close js-flash-close">  <svg aria-hidden="true" height="16" viewBox="0 0 16 16" version="1.1" width="16" data-view-component="true" class="octicon octicon-x Button-visual">
    <path d="M3.72 3.72a.75.75 0 0 1 1.06 0L8 6.94l3.22-3.22a.749.749 0 0 1 1.275.326.749.749 0 0 1-.215.734L9.06 8l3.22 3.22a.749.749 0 0 1-.326 1.275.749.749 0 0 1-.734-.215L8 9.06l-3.22 3.22a.751.751 0 0 1-1.042-.018.751.751 0 0 1-.018-1.042L6.94 8 3.72 4.78a.75.75 0 0 1 0-1.06Z"></path>
</svg>
</button><tool-tip id="tooltip-fdecd9f3-992c-41b9-b813-6c197745d411" for="icon-button-67c69b8b-ed89-469f-85e9-7410fae1569a" popover="manual" data-direction="s" data-type="label" data-view-component="true" class="sr-only position-absolute">Dismiss alert</tool-tip>
...
<div class="flash flash-full   {{ className }}">
  ...
  <notification-shelf-watcher data-base-url="https://github.com/notifications/beta/shelf" data-channel="eyJjIjoibm90aWZpY2F0aW9uLWNoYW5nZWQ6MTkwNjUzNjk0IiwidCI6MTc0MTI5NDExNH0=--c9a058b32e8019250e6eedf8126d975efe1671f464ed32dadd10376a70f9ef52" data-view-component="true" class="js-socket-channel"></notification-shelf-watcher>
...
<react-app
  ...
  initial-path="/32ES/ESP32/blob/main/20_touch.ino"
...
>
  ...
  <script type="application/json" data-target="react-app.embeddedData">{"payload":{"allShortcutsEnabled":true,"fileTree":{"":{"items":[{"name":"10_RGB.ino","path":"10_RGB.ino","contentType":"file"},{"name":"11_Push_button_LED.ino","path":"11_Push_button_LED.ino","contentType":"file"},{"name":"12_Analoginput.ino","path":"12_Analoginput.ino","contentType":"file"},{"name":"13_Dimmer.ino","path":"13_Dimmer.ino","contentType":"file"},{"name":"14_Buzzer.ino","path":"14_Buzzer.ino","contentType":"file"},{"name":"15_LDR.ino","path":"15_LDR.ino","contentType":"file"},{"name":"16_IR.ino","path":"16_IR.ino","contentType":"file"},{"name":"17_DHT11_OLED.ino","path":"17_DHT11_OLED.ino","contentType":"file"},{"name":"19_Relay.ino","path":"19_Relay.ino","contentType":"file"},{"name":"20_touch.ino","path":"20_touch.ino","contentType":"file"},{"name":"21_WiFi_LED.ino","path":"21_WiFi_LED.ino","contentType":"file"},{"name":"22_WiFi_DHT11.ino","path":"22_WiFi_DHT11.ino","contentType":"file"},{"name":"23_Firebase_LED.ino","path":"23_Firebase_LED.ino","contentType":"file"},{"name":"24_Firebase_LED_count.ino","path":"24_Firebase_LED_count.ino","contentType":"file"},{"name":"5_Serial_first_time.ino","path":"5_Serial_first_time.ino","contentType":"file"},{"name":"7_Serial_monitor_calc.ino","path":"7_Serial_monitor_calc.ino","contentType":"file"},{"name":"8_LED_blink_onboard.ino","path":"8_LED_blink_onboard.ino","contentType":"file"},{"name":"9_LED_blink_external.ino","path":"9_LED_blink_external.ino","contentType":"file"},{"name":"Logo ESP32.png","path":"Logo ESP32.png","contentType":"file"}],"totalCount":19}},"fileTreeProcessingTime":2.043063,"foldersToFetch":[],"repo":{"id":905597089,"defaultBranch":"main","name":"ESP32","ownerLogin":"32ES","currentUserCanPush":true,"isFork":false,"isEmpty":false,"createdAt":"2024-12-19T08:37:52.000+02:00","ownerAvatar":"https://avatars.githubusercontent.com/u/190653694?v=4","public":true,"private":false,"isOrgOwned":false},"codeLineWrapEnabled":false,"symbolsExpanded":false,"treeExpanded":true,"refInfo":{"name":"main","listCacheKey":"v0:1734590783.0","canEdit":true,"refType":"branch","currentOid":"d3729cb5972014ca5396ec65e8f4fa21b8187e27"},"path":"20_touch.ino","currentUser":{"id":190653694,"login":"32ES","userEmail":"electronica4us@gmail.com"},"blob":{"rawLines":["#define LED_PIN 18    // Pin for the LED","#define TOUCH_PIN_ON 4  // Pin for the touch input to turn the LED ON","#define TOUCH_PIN_OFF 15 // Pin for the touch input to turn the LED OFF","","bool ledStatus = LOW; // Variable to track the LED status","","void setup() {","  // Start the serial monitor for debugging","  Serial.begin(115200);","  ","  // Set the LED pin as output","  pinMode(LED_PIN, OUTPUT);","}","","void loop() {","  // Read touch sensor values","  int touchValueOn = touchRead(TOUCH_PIN_ON);  // Read touch value from GPIO4","  int touchValueOff = touchRead(TOUCH_PIN_OFF); // Read touch value from GPIO15","  ","  // Check if touch on GPIO4 is detected (below a certain threshold, e.g., 40)","  if (touchValueOn \u003c 67) {","    digitalWrite(LED_PIN, HIGH);  // Turn on the LED","    ledStatus = HIGH;  // Update the LED status","  }","  // Check if touch on GPIO15 is detected (below a certain threshold, e.g., 40)","  else if (touchValueOff \u003c 67) {","    digitalWrite(LED_PIN, LOW);  // Turn off the LED","    ledStatus = LOW;  // Update the LED status","  }","","  // Print the status in the same line","  Serial.print(\"LED Status: \");","  if (ledStatus == HIGH) {","    Serial.print(\"ON\");","  } else {","    Serial.print(\"OFF\");","  }","  Serial.print(\" | Touch 1 (GPIO4): \");","  Serial.print(touchValueOn);","  Serial.print(\" | Touch 2 (GPIO15): \");","  Serial.println(touchValueOff);","  ","  delay(500); // Delay for better readability","}"],"stylingDirectives":null,"colorizedLines":["#\u003cspan class=\"pl-k\"\u003edefine\u003c/span\u003e \u003cspan class=\"pl-en\"\u003eLED_PIN\u003c/span\u003e \u003cspan class=\"pl-c1\"\u003e18\u003c/span\u003e    \u003cspan class=\"pl-c\"\u003e\u003cspan class=\"pl-c\"\u003e//\u003c/span\u003e Pin for the LED\u003c/span\u003e","#\u003cspan class=\"pl-k\"\u003edefine\u003c/span\u003e \u003cspan class=\"pl-en\"\u003eTOUCH_PIN_ON\u003c/span\u003e \u003cspan class=\"pl-c1\"\u003e4\u003c/span\u003e  \u003cspan class=\"pl-c\"\u003e\u003cspan class=\"pl-c\"\u003e//\u003c/span\u003e Pin for the touch input to turn the LED ON\u003c/span\u003e","#\u003cspan class=\"pl-k\"\u003edefine\u003c/span\u003e \u003cspan class=\"pl-en\"\u003eTOUCH_PIN_OFF\u003c/span\u003e \u003cspan class=\"pl-c1\"\u003e15\u003c/span\u003e \u003cspan class=\"pl-c\"\u003e\u003cspan class=\"pl-c\"\u003e//\u003c/span\u003e Pin for the touch input to turn the LED OFF\u003c/span\u003e","","\u003cspan class=\"pl-k\"\u003ebool\u003c/span\u003e ledStatus = LOW; \u003cspan class=\"pl-c\"\u003e\u003cspan class=\"pl-c\"\u003e//\u003c/span\u003e Variable to track the LED status\u003c/span\u003e","","\u003cspan class=\"pl-k\"\u003evoid\u003c/span\u003e \u003cspan class=\"pl-en\"\u003esetup\u003c/span\u003e() {","  \u003cspan class=\"pl-c\"\u003e\u003cspan class=\"pl-c\"\u003e//\u003c/span\u003e Start the serial monitor for debugging\u003c/span\u003e","  Serial.\u003cspan class=\"pl-c1\"\u003ebegin\u003c/span\u003e(\u003cspan class=\"pl-c1\"\u003e115200\u003c/span\u003e);","  ","  \u003cspan class=\"pl-c\"\u003e\u003cspan class=\"pl-c\"\u003e//\u003c/span\u003e Set the LED pin as output\u003c/span\u003e","  \u003cspan class=\"pl-c1\"\u003epinMode\u003c/span\u003e(LED_PIN, OUTPUT);","}","","\u003cspan class=\"pl-k\"\u003evoid\u003c/span\u003e \u003cspan class=\"pl-en\"\u003eloop\u003c/span\u003e() {","  \u003cspan class=\"pl-c\"\u003e\u003cspan class=\"pl-c\"\u003e//\u003c/span\u003e Read touch sensor values\u003c/span\u003e","  \u003cspan class=\"pl-k\"\u003eint\u003c/span\u003e touchValueOn = \u003cspan class=\"pl-c1\"\u003etouchRead\u003c/span\u003e(TOUCH_PIN_ON);  \u003cspan class=\"pl-c\"\u003e\u003cspan class=\"pl-c\"\u003e//\u003c/span\u003e Read touch value from GPIO4\u003c/span\u003e","  \u003cspan class=\"pl-k\"\u003eint\u003c/span\u003e touchValueOff = \u003cspan class=\"pl-c1\"\u003etouchRead\u003c/span\u003e(TOUCH_PIN_OFF); \u003cspan class=\"pl-c\"\u003e\u003cspan class=\"pl-c\"\u003e//\u003c/span\u003e Read touch value from GPIO15\u003c/span\u003e","  ","  \u003cspan class=\"pl-c\"\u003e\u003cspan class=\"pl-c\"\u003e//\u003c/span\u003e Check if touch on GPIO4 is detected (below a certain threshold, e.g., 40)\u003c/span\u003e","  \u003cspan class=\"pl-k\"\u003eif\u003c/span\u003e (touchValueOn \u0026lt; \u003cspan class=\"pl-c1\"\u003e67\u003c/span\u003e) {","    \u003cspan class=\"pl-c1\"\u003edigitalWrite\u003c/span\u003e(LED_PIN, HIGH);  \u003cspan class=\"pl-c\"\u003e\u003cspan class=\"pl-c\"\u003e//\u003c/span\u003e Turn on the LED\u003c/span\u003e","    ledStatus = HIGH;  \u003cspan class=\"pl-c\"\u003e\u003cspan class=\"pl-c\"\u003e//\u003c/span\u003e Update the LED status\u003c/span\u003e","  }","  \u003cspan class=\"pl-c\"\u003e\u003cspan class=\"pl-c\"\u003e//\u003c/span\u003e Check if touch on GPIO15 is detected (below a certain threshold, e.g., 40)\u003c/span\u003e","  \u003cspan class=\"pl-k\"\u003eelse\u003c/span\u003e \u003cspan class=\"pl-k\"\u003eif\u003c/span\u003e (touchValueOff \u0026lt; \u003cspan class=\"pl-c1\"\u003e67\u003c/span\u003e) {","    \u003cspan class=\"pl-c1\"\u003edigitalWrite\u003c/span\u003e(LED_PIN, LOW);  \u003cspan class=\"pl-c\"\u003e\u003cspan class=\"pl-c\"\u003e//\u003c/span\u003e Turn off the LED\u003c/span\u003e","    ledStatus = LOW;  \u003cspan class=\"pl-c\"\u003e\u003cspan class=\"pl-c\"\u003e//\u003c/span\u003e Update the LED status\u003c/span\u003e","  }","","  \u003cspan class=\"pl-c\"\u003e\u003cspan class=\"pl-c\"\u003e//\u003c/span\u003e Print the status in the same line\u003c/span\u003e","  Serial.\u003cspan class=\"pl-c1\"\u003eprint\u003c/span\u003e(\u003cspan class=\"pl-s\"\u003e\u003cspan class=\"pl-pds\"\u003e\u0026quot;\u003c/span\u003eLED Status: \u003cspan class=\"pl-pds\"\u003e\u0026quot;\u003c/span\u003e\u003c/span\u003e);","  \u003cspan class=\"pl-k\"\u003eif\u003c/span\u003e (ledStatus == HIGH) {","    Serial.\u003cspan class=\"pl-c1\"\u003eprint\u003c/span\u003e(\u003cspan class=\"pl-s\"\u003e\u003cspan class=\"pl-pds\"\u003e\u0026quot;\u003c/span\u003eON\u003cspan class=\"pl-pds\"\u003e\u0026quot;\u003c/span\u003e\u003c/span\u003e);","  } \u003cspan class=\"pl-k\"\u003eelse\u003c/span\u003e {","    Serial.\u003cspan class=\"pl-c1\"\u003eprint\u003c/span\u003e(\u003cspan class=\"pl-s\"\u003e\u003cspan class=\"pl-pds\"\u003e\u0026quot;\u003c/span\u003eOFF\u003cspan class=\"pl-pds\"\u003e\u0026quot;\u003c/span\u003e\u003c/span\u003e);","  }","  Serial.\u003cspan class=\"pl-c1\"\u003eprint\u003c/span\u003e(\u003cspan class=\"pl-s\"\u003e\u003cspan class=\"pl-pds\"\u003e\u0026quot;\u003c/span\u003e | Touch 1 (GPIO4): \u003cspan class=\"pl-pds\"\u003e\u0026quot;\u003c/span\u003e\u003c/span\u003e);","  Serial.\u003cspan class=\"pl-c1\"\u003eprint\u003c/span\u003e(touchValueOn);","  Serial.\u003cspan class=\"pl-c1\"\u003eprint\u003c/span\u003e(\u003cspan class=\"pl-s\"\u003e\u003cspan class=\"pl-pds\"\u003e\u0026quot;\u003c/span\u003e | Touch 2 (GPIO15): \u003cspan class=\"pl-pds\"\u003e\u0026quot;\u003c/span\u003e\u003c/span\u003e);","  Serial.\u003cspan class=\"pl-c1\"\u003eprintln\u003c/span\u003e(touchValueOff);","  ","  \u003cspan class=\"pl-c1\"\u003edelay\u003c/span\u003e(\u003cspan class=\"pl-c1\"\u003e500\u003c/span\u003e); \u003cspan class=\"pl-c\"\u003e\u003cspan class=\"pl-c\"\u003e//\u003c/span\u003e Delay for better readability\u003c/span\u003e","}"],"csv":null,"csvError":null,"dependabotInfo":{"showConfigurationBanner":false,"configFilePath":null,"networkDependabotPath":"/32ES/ESP32/network/updates","dismissConfigurationNoticePath":"/settings/dismiss-notice/dependabot_configuration_notice","configurationNoticeDismissed":false},"displayName":"20_touch.ino","displayUrl":"https://github.com/32ES/ESP32/blob/main/20_touch.ino?raw=true","headerInfo":{"blobSize":"1.35 KB","deleteTooltip":"Delete this file","editTooltip":"Edit this file","ghDesktopPath":"https://desktop.github.com","isGitLfs":false,"onBranch":true,"shortPath":"da783d9","siteNavLoginPath":"/login?return_to=https%3A%2F%2Fgithub.com%2F32ES%2FESP32%2Fblob%2Fmain%2F20_touch.ino","isCSV":false,"isRichtext":false,"toc":null,"lineInfo":{"truncatedLoc":"44","truncatedSloc":"37"},"mode":"file"},"image":false,"isCodeownersFile":null,"isPlain":false,"isValidLegacyIssueTemplate":false,"issueTemplate":null,"discussionTemplate":null,"language":"C++","languageID":43,"large":false,"planSupportInfo":{"repoIsFork":null,"repoOwnedByCurrentUser":null,"requestFullPath":"/32ES/ESP32/blob/main/20_touch.ino","showFreeOrgGatedFeatureMessage":null,"showPlanSupportBanner":null,"upgradeDataAttributes":null,"upgradePath":null},"publishBannersInfo":{"dismissActionNoticePath":"/settings/dismiss-notice/publish_action_from_dockerfile","releasePath":"/32ES/ESP32/releases/new?marketplace=true","showPublishActionBanner":false},"rawBlobUrl":"https://github.com/32ES/ESP32/raw/refs/heads/main/20_touch.ino","renderImageOrRaw":false,"richText":null,"renderedFileInfo":null,"shortPath":null,"symbolsEnabled":true,"tabSize":8,"topBannersInfo":{"overridingGlobalFundingFile":false,"globalPreferredFundingPath":null,"showInvalidCitationWarning":false,"citationHelpUrl":"https://docs.github.com/github/creating-cloning-and-archiving-repositories/creating-a-repository-on-github/about-citation-files","actionsOnboardingTip":null},"truncated":false,"viewable":true,"workflowRedirectUrl":null,"symbols":{"timed_out":false,"not_analyzed":false,"symbols":[{"name":"setup","kind":"function","ident_start":248,"ident_end":253,"extent_start":243,"extent_end":389,"fully_qualified_name":"setup","ident_utf16":{"start":{"line_number":6,"utf16_col":5},"end":{"line_number":6,"utf16_col":10}},"extent_utf16":{"start":{"line_number":6,"utf16_col":0},"end":{"line_number":12,"utf16_col":1}}},{"name":"loop","kind":"function","ident_start":396,"ident_end":400,"extent_start":391,"extent_end":1381,"fully_qualified_name":"loop","ident_utf16":{"start":{"line_number":14,"utf16_col":5},"end":{"line_number":14,"utf16_col":9}},"extent_utf16":{"start":{"line_number":14,"utf16_col":0},"end":{"line_number":43,"utf16_col":1}}}]}},"copilotInfo":{"documentationUrl":"https://docs.github.com/copilot/overview-of-github-copilot/about-github-copilot-for-individuals","notices":{"codeViewPopover":{"dismissed":false,"dismissPath":"/settings/dismiss-notice/code_view_copilot_popover"}},"userAccess":{"hasSubscriptionEnded":false,"orgHasCFBAccess":false,"userHasCFIAccess":false,"userHasOrgs":false,"userIsOrgAdmin":false,"userIsOrgMember":false,"business":null,"featureRequestInfo":null}},"copilotAccessAllowed":false,"modelsAccessAllowed":false,"csrf_tokens":{"/32ES/ESP32/branches":{"post":"4jpX4V7X337imU49L8B8HZVqdp20mm4ne4SZxgP7pVEN8QK6A00ol5QfBSHI9v7l1eoon2Ay9qrZ_C_GoeXOGw"},"/repos/preferences":{"post":"KzAnLsZaM3VZOrrhW1IZ_UEVR45am1NTAQl0LQMUaLZDpkJe6EOprQw4BPfkNpler7r4DpllpfNUurkDgBzk2g"}}},"title":"ESP32/20_touch.ino at main · 32ES/ESP32","appPayload":{"helpUrl":"https://docs.github.com","findFileWorkerPath":"/assets-cdn/worker/find-file-worker-7d7eb7c71814.js","findInFileWorkerPath":"/assets-cdn/worker/find-in-file-worker-96e76d5fdb2c.js","githubDevUrl":"https://github.dev/","enabled_features":{"code_nav_ui_events":false,"overview_shared_code_dropdown_button":false,"react_blob_overlay":true,"copilot_conversational_ux_embedding_update":false,"copilot_smell_icebreaker_ux":true,"accessible_code_button":true}}}</script>
...
<div id="LC8" class="react-code-text react-code-line-contents-no-virtualization react-file-line html-div child-of-line-6 ">  <span class="pl-c"><span class="pl-c">//</span> Start the serial monitor for debugging</span></div>
...
<div id="LC11" class="react-code-text react-code-line-contents-no-virtualization react-file-line html-div child-of-line-6 ">  <span class="pl-c"><span class="pl-c">//</span> Set the LED pin as output</span></div>
<div id="LC12" class="react-code-text react-code-line-contents-no-virtualization react-file-line html-div child-of-line-6 ">  <span class="pl-c1">pinMode</span>(LED_PIN, OUTPUT);</div>
...
<div id="LC16" class="react-code-text react-code-line-contents-no-virtualization react-file-line html-div child-of-line-14 ">  <span class="pl-c"><span class="pl-c">//</span> Read touch sensor values</span></div>
<div id="LC17" class="react-code-text react-code-line-contents-no-virtualization react-file-line html-div child-of-line-14 ">  <span class="pl-k">int</span> touchValueOn = <span class="pl-c1">touchRead</span>(TOUCH_PIN_ON);  <span class="pl-c"><span class="pl-c">//</span> Read touch value from GPIO4</span></div>
<div id="LC18" class="react-code-text react-code-line-contents-no-virtualization react-file-line html-div child-of-line-14 ">  <span class="pl-k">int</span> touchValueOff = <span class="pl-c1">touchRead</span>(TOUCH_PIN_OFF); <span class="pl-c"><span class="pl-c">//</span> Read touch value from GPIO15</span></div>
...
<div id="LC20" class="react-code-text react-code-line-contents-no-virtualization react-file-line html-div child-of-line-14 ">  <span class="pl-c"><span class="pl-c">//</span> Check if touch on GPIO4 is detected (below a certain threshold, e.g., 40)</span></div>
<div id="LC21" class="react-code-text react-code-line-contents-no-virtualization react-file-line html-div child-of-line-14 ">  <span class="pl-k">if</span> (touchValueOn &lt; <span class="pl-c1">67</span>) {</div>
<div id="LC22" class="react-code-text react-code-line-contents-no-virtualization react-file-line html-div child-of-line-14 ">    <span class="pl-c1">digitalWrite</span>(LED_PIN, HIGH);  <span class="pl-c"><span class="pl-c">//</span> Turn on the LED</span></div>
<div id="LC23" class="react-code-text react-code-line-contents-no-virtualization react-file-line html-div child-of-line-14 ">    ledStatus = HIGH;  <span class="pl-c"><span class="pl-c">//</span> Update the LED status</span></div>
...
<div id="LC25" class="react-code-text react-code-line-contents-no-virtualization react-file-line html-div child-of-line-14 ">  <span class="pl-c"><span class="pl-c">//</span> Check if touch on GPIO15 is detected (below a certain threshold, e.g., 40)</span></div>
<div id="LC26" class="react-code-text react-code-line-contents-no-virtualization react-file-line html-div child-of-line-14 ">  <span class="pl-k">else</span> <span class="pl-k">if</span> (touchValueOff &lt; <span class="pl-c1">67</span>) {</div>
<div id="LC27" class="react-code-text react-code-line-contents-no-virtualization react-file-line html-div child-of-line-14 ">    <span class="pl-c1">digitalWrite</span>(LED_PIN, LOW);  <span class="pl-c"><span class="pl-c">//</span> Turn off the LED</span></div>
<div id="LC28" class="react-code-text react-code-line-contents-no-virtualization react-file-line html-div child-of-line-14 ">    ledStatus = LOW;  <span class="pl-c"><span class="pl-c">//</span> Update the LED status</span></div>
...
<div id="LC31" class="react-code-text react-code-line-contents-no-virtualization react-file-line html-div child-of-line-14 ">  <span class="pl-c"><span class="pl-c">//</span> Print the status in the same line</span></div>
<div id="LC32" class="react-code-text react-code-line-contents-no-virtualization react-file-line html-div child-of-line-14 ">  Serial.<span class="pl-c1">print</span>(<span class="pl-s"><span class="pl-pds">&quot;</span>LED Status: <span class="pl-pds">&quot;</span></span>);</div>
<div id="LC33" class="react-code-text react-code-line-contents-no-virtualization react-file-line html-div child-of-line-14 ">  <span class="pl-k">if</span> (ledStatus == HIGH) {</div>
<div id="LC34" class="react-code-text react-code-line-contents-no-virtualization react-file-line html-div child-of-line-14 ">    Serial.<span class="pl-c1">print</span>(<span class="pl-s"><span class="pl-pds">&quot;</span>ON<span class="pl-pds">&quot;</span></span>);</div>
<div id="LC35" class="react-code-text react-code-line-contents-no-virtualization react-file-line html-div child-of-line-14 ">  } <span class="pl-k">else</span> {</div>
<div id="LC36" class="react-code-text react-code-line-contents-no-virtualization react-file-line html-div child-of-line-14 ">    Serial.<span class="pl-c1">print</span>(<span class="pl-s"><span class="pl-pds">&quot;</span>OFF<span class="pl-pds">&quot;</span></span>);</div>
<div id="LC37" class="react-code-text react-code-line-contents-no-virtualization react-file-line html-div child-of-line-14 ">  }</div>
<div id="LC38" class="react-code-text react-code-line-contents-no-virtualization react-file-line html-div child-of-line-14 ">  Serial.<span class="pl-c1">print</span>(<span class="pl-s"><span class="pl-pds">&quot;</span> | Touch 1 (GPIO4): <span class="pl-pds">&quot;</span></span>);</div>
<div id="LC39" class="react-code-text react-code-line-contents-no-virtualization react-file-line html-div child-of-line-14 ">  Serial.<span class="pl-c1">print</span>(touchValueOn);</div>
<div id="LC40" class="react-code-text react-code-line-contents-no-virtualization react-file-line html-div child-of-line-14 ">  Serial.<span class="pl-c1">print</span>(<span class="pl-s"><span class="pl-pds">&quot;</span> | Touch 2 (GPIO15): <span class="pl-pds">&quot;</span></span>);</div>
<div id="LC41" class="react-code-text react-code-line-contents-no-virtualization react-file-line html-div child-of-line-14 ">  Serial.<span class="pl-c1">println</span>(touchValueOff);</div>
<div id="LC42" class="react-code-text react-code-line-contents-no-virtualization react-file-line html-div child-of-line-14 ">  </div>
<div id="LC43" class="react-code-text react-code-line-contents-no-virtualization react-file-line html-div child-of-line-14 ">  <span class="pl-c1">delay</span>(<span class="pl-c1">500</span>); <span class="pl-c"><span class="pl-c">//</span> Delay for better readability</span></div>
<div id="LC44" class="react-code-text react-code-line-contents-no-virtualization react-file-line html-div ">}</div></div></div></div></div><div id="copilot-button-container"></div></div><div id="highlighted-line-menu-container"></div></div></div><button hidden="" data-testid="hotkey-button" data-hotkey-scope="read-only-cursor-text-area"></button><button hidden=""></button></section></div></div></div> <!-- --> <!-- --> </div></div></div><div class="Box-sc-g0xbh4-0"></div></div></div></div></div><div id="find-result-marks-container" class="Box-sc-g0xbh4-0 cCoXib"></div><button hidden="" data-testid="" data-hotkey-scope="read-only-cursor-text-area"></button><button hidden=""></button></div> <!-- --> <!-- --> <script type="application/json" id="__PRIMER_DATA_:R0:__">{"resolvedServerColorMode":"day"}</script></div>
</react-app>
</turbo-frame>
