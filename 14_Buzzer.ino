...
<link crossorigin="anonymous" media="all" rel="stylesheet" href="https://github.githubassets.com/assets/react-code-view.ab7d8fac328c00e5e0cc.module.css" />
  ...
  <title>ESP32/14_Buzzer.ino at main · 32ES/ESP32</title>
  ...
  <meta name="request-id" content="0701:376587:6972E:DE7A0:67CA0A00" data-turbo-transient="true" /><meta name="html-safe-nonce" content="d9831b25491ef5c020d3355ef288eaa25406e60d4633e021b9f42aff64a97bf0" data-turbo-transient="true" /><meta name="visitor-payload" content="eyJyZWZlcnJlciI6Imh0dHBzOi8vZ2l0aHViLmNvbS8zMkVTL0VTUDMyIiwicmVxdWVzdF9pZCI6IjA3MDE6Mzc2NTg3OjY5NzJFOkRFN0EwOjY3Q0EwQTAwIiwidmlzaXRvcl9pZCI6IjY2NjEyMDIzMDU5NTE0MzQ2MDQiLCJyZWdpb25fZWRnZSI6ImlzcmFlbGNlbnRyYWwiLCJyZWdpb25fcmVuZGVyIjoiaWFkIn0=" data-turbo-transient="true" /><meta name="visitor-hmac" content="21ee4b9f0ceba737aa65c28f4b61825576f5c8152986164792c5f6be37f846f2" data-turbo-transient="true" />
...
<meta name="octolytics-url" content="https://collector.github.com/github/collect" /><meta name="octolytics-actor-id" content="190653694" /><meta name="octolytics-actor-login" content="32ES" /><meta name="octolytics-actor-hash" content="6e23f7da5969f1eb89aff2cd86650b5454e97ff5fc904b7450ae67566cbbe58c" />
  ...
  <link rel="sudo-modal" href="/sessions/sudo_modal">
    ...
    <meta name="apple-itunes-app" content="app-id=1477376905, app-argument=https://github.com/32ES/ESP32/blob/main/14_Buzzer.ino" />

      <meta name="twitter:image" content="https://opengraph.githubassets.com/df7cefd32a3f81f8dd0e99a09b92ab71823f7a84d235f023bd76497c4d239c09/32ES/ESP32" /><meta name="twitter:site" content="@github" /><meta name="twitter:card" content="summary_large_image" /><meta name="twitter:title" content="ESP32/14_Buzzer.ino at main · 32ES/ESP32" /><meta name="twitter:description" content="Contribute to 32ES/ESP32 development by creating an account on GitHub." />
  <meta property="og:image" content="https://opengraph.githubassets.com/df7cefd32a3f81f8dd0e99a09b92ab71823f7a84d235f023bd76497c4d239c09/32ES/ESP32" /><meta property="og:image:alt" content="Contribute to 32ES/ESP32 development by creating an account on GitHub." /><meta property="og:image:width" content="1200" /><meta property="og:image:height" content="600" /><meta property="og:site_name" content="GitHub" /><meta property="og:type" content="object" /><meta property="og:title" content="ESP32/14_Buzzer.ino at main · 32ES/ESP32" /><meta property="og:url" content="https://github.com/32ES/ESP32/blob/main/14_Buzzer.ino" /><meta property="og:description" content="Contribute to 32ES/ESP32 development by creating an account on GitHub." />
  


      <link rel="shared-web-socket" href="wss://alive.github.com/_sockets/u/190653694/ws?session=eyJ2IjoiVjMiLCJ1IjoxOTA2NTM2OTQsInMiOjE1OTk2Njc1MDMsImMiOjQyMDYyNDMxMjEsInQiOjE3NDEyOTQwODZ9--11b35be077727746c9e1acd29b532dbf258505f96135c554a876bec0ce72ee14" data-refresh-url="/_alive" data-session-id="c1fb51bc7de77b54343da3cb1b5990c000bf0b6edcac44cf8a54715cb7924a35">
...
>
  ...
  <include-fragment data-target="deferred-side-panel.fragment">
      <button aria-label="Open global navigation menu" data-action="click:deferred-side-panel#loadPanel click:deferred-side-panel#panelOpened" data-show-dialog-id="dialog-921a545d-f2db-4d40-8cfa-e6a491ffac59" id="dialog-show-dialog-921a545d-f2db-4d40-8cfa-e6a491ffac59" type="button" data-view-component="true" class="Button Button--iconOnly Button--secondary Button--medium AppHeader-button p-0 color-fg-muted">  <svg aria-hidden="true" height="16" viewBox="0 0 16 16" version="1.1" width="16" data-view-component="true" class="octicon octicon-three-bars Button-visual">
    <path d="M1 2.75A.75.75 0 0 1 1.75 2h12.5a.75.75 0 0 1 0 1.5H1.75A.75.75 0 0 1 1 2.75Zm0 5A.75.75 0 0 1 1.75 7h12.5a.75.75 0 0 1 0 1.5H1.75A.75.75 0 0 1 1 7.75ZM1.75 12h12.5a.75.75 0 0 1 0 1.5H1.75a.75.75 0 0 1 0-1.5Z"></path>
</svg>
</button>

<dialog-helper>
  <dialog data-target="deferred-side-panel.panel" id="dialog-921a545d-f2db-4d40-8cfa-e6a491ffac59" aria-modal="true" aria-labelledby="dialog-921a545d-f2db-4d40-8cfa-e6a491ffac59-title" aria-describedby="dialog-921a545d-f2db-4d40-8cfa-e6a491ffac59-description" data-view-component="true" class="Overlay Overlay-whenNarrow Overlay--size-small-portrait Overlay--motion-scaleFade Overlay--placement-left SidePanel Overlay--disableScroll">
    <div styles="flex-direction: row;" data-view-component="true" class="Overlay-header">
  <div class="Overlay-headerContentWrap">
    <div class="Overlay-titleWrap">
      <h1 class="Overlay-title sr-only" id="dialog-921a545d-f2db-4d40-8cfa-e6a491ffac59-title">
        Global navigation
      </h1>
    ...
    <div class="Overlay-actionWrap">
      <button data-close-dialog-id="dialog-921a545d-f2db-4d40-8cfa-e6a491ffac59" aria-label="Close" type="button" data-view-component="true" class="close-button Overlay-closeButton"><svg aria-hidden="true" height="16" viewBox="0 0 16 16" version="1.1" width="16" data-view-component="true" class="octicon octicon-x">
    <path d="M3.72 3.72a.75.75 0 0 1 1.06 0L8 6.94l3.22-3.22a.749.749 0 0 1 1.275.326.749.749 0 0 1-.215.734L9.06 8l3.22 3.22a.749.749 0 0 1-.326 1.275.749.749 0 0 1-.734-.215L8 9.06l-3.22 3.22a.751.751 0 0 1-1.042-.018.751.751 0 0 1-.018-1.042L6.94 8 3.72 4.78a.75.75 0 0 1 0-1.06Z"></path>
      ...
      <scrollable-region data-labelled-by="dialog-921a545d-f2db-4d40-8cfa-e6a491ffac59-title">
...
<li data-item-id="" data-targets="nav-list.items" data-view-component="true" class="ActionListItem">
    ...
    <a data-hotkey="g d" data-analytics-event="{&quot;category&quot;:&quot;Global navigation&quot;,&quot;action&quot;:&quot;HOME&quot;,&quot;label&quot;:null}" id="item-f6aefdc5-dd9e-4e59-bf23-0cdd4e5508eb" href="/dashboard" data-view-component="true" class="ActionListContent ActionListContent--visual16">
...
<li data-item-id="" data-targets="nav-list.items" data-view-component="true" class="ActionListItem">
    ...
    <a data-hotkey="g i" data-analytics-event="{&quot;category&quot;:&quot;Global navigation&quot;,&quot;action&quot;:&quot;ISSUES&quot;,&quot;label&quot;:null}" id="item-acb21a54-c57b-40cb-8a1b-ea8b71452f28" href="/issues" data-view-component="true" class="ActionListContent ActionListContent--visual16">
        <span class="ActionListItem-visual ActionListItem-visual--leading">
...
<li data-item-id="" data-targets="nav-list.items" data-view-component="true" class="ActionListItem">
    ...
    <a data-hotkey="g p" data-analytics-event="{&quot;category&quot;:&quot;Global navigation&quot;,&quot;action&quot;:&quot;PULL_REQUESTS&quot;,&quot;label&quot;:null}" id="item-48da2294-7df9-47b4-b9dc-81675362cf4a" href="/pulls" data-view-component="true" class="ActionListContent ActionListContent--visual16">
        <span class="ActionListItem-visual ActionListItem-visual--leading">
...
<li data-item-id="" data-targets="nav-list.items" data-item-id="projects" data-view-component="true" class="ActionListItem">
    ...
    <a data-analytics-event="{&quot;category&quot;:&quot;Global navigation&quot;,&quot;action&quot;:&quot;PROJECTS&quot;,&quot;label&quot;:null}" id="item-c67b585c-f0ab-40a1-91f5-e37d247a7aa6" href="/projects" data-view-component="true" class="ActionListContent ActionListContent--visual16">
        <span class="ActionListItem-visual ActionListItem-visual--leading">
...
<li data-item-id="" data-targets="nav-list.items" data-view-component="true" class="ActionListItem">
    ...
    <a data-analytics-event="{&quot;category&quot;:&quot;Global navigation&quot;,&quot;action&quot;:&quot;DISCUSSIONS&quot;,&quot;label&quot;:null}" id="item-e262d2a3-cf72-4868-b4ab-1109f0964609" href="/discussions" data-view-component="true" class="ActionListContent ActionListContent--visual16">
        <span class="ActionListItem-visual ActionListItem-visual--leading">
...
<li data-item-id="" data-targets="nav-list.items" data-view-component="true" class="ActionListItem">
    ...
    <a data-analytics-event="{&quot;category&quot;:&quot;Global navigation&quot;,&quot;action&quot;:&quot;CODESPACES&quot;,&quot;label&quot;:null}" id="item-ca051337-0947-45e7-ad80-27facabfc668" href="https://github.com/codespaces" data-view-component="true" class="ActionListContent ActionListContent--visual16">
        <span class="ActionListItem-visual ActionListItem-visual--leading">
...
<li data-item-id="" data-targets="nav-list.items" data-view-component="true" class="ActionListItem">
    ...
    <a data-analytics-event="{&quot;category&quot;:&quot;Global navigation&quot;,&quot;action&quot;:&quot;COPILOT&quot;,&quot;label&quot;:null}" id="item-a38848aa-8202-4119-8d71-c49d6ff49ce0" href="/copilot" data-view-component="true" class="ActionListContent ActionListContent--visual16">
        <span class="ActionListItem-visual ActionListItem-visual--leading">
...
<li data-item-id="" data-targets="nav-list.items" data-view-component="true" class="ActionListItem">
    ...
    <a data-analytics-event="{&quot;category&quot;:&quot;Global navigation&quot;,&quot;action&quot;:&quot;EXPLORE&quot;,&quot;label&quot;:null}" id="item-331c7bcf-2b45-4ffe-b2f7-5ba68d50cdad" href="/explore" data-view-component="true" class="ActionListContent ActionListContent--visual16">
        <span class="ActionListItem-visual ActionListItem-visual--leading">
...
<li data-item-id="" data-targets="nav-list.items" data-view-component="true" class="ActionListItem">
    ...
    <a data-analytics-event="{&quot;category&quot;:&quot;Global navigation&quot;,&quot;action&quot;:&quot;MARKETPLACE&quot;,&quot;label&quot;:null}" id="item-d929af99-44d3-46f6-bc1c-f63875e6e478" href="/marketplace" data-view-component="true" class="ActionListContent ActionListContent--visual16">
        <span class="ActionListItem-visual ActionListItem-visual--leading">
    ...
    <path d="M10.68 11.74a6 6 0 0 1-7.922-8.982 6 6 0 0 1 8.982 7.922l3.04 3.04a.749.749 0 0 1-.326 1.275.749.749 0 0 1-.734-.215ZM11.5 7a4.499 4.499 0 1 0-8.997 0A4.499 4.499 0 0 0 11.5 7Z"></path>
        ...
        <div data-target="query-builder.styledInputContainer" class="QueryBuilder-StyledInputContainer">
          ...
          <div class="QueryBuilder-InputWrapper">
            ...
            <input id="query-builder-test" name="query-builder-test" value="" autocomplete="off" type="text" role="combobox" spellcheck="false" aria-expanded="false" aria-describedby="validation-247271c4-a955-423c-a3d1-1d6b95e148f6" data-target="query-builder.input" data-action="
...
<template id="device-desktop-icon">
  <svg aria-hidden="true" height="16" viewBox="0 0 16 16" version="1.1" width="16" data-view-component="true" class="octicon octicon-device-desktop">
    <path d="M14.25 1c.966 0 1.75.784 1.75 1.75v7.5A1.75 1.75 0 0 1 14.25 12h-3.727c.099 1.041.52 1.872 1.292 2.757A.752.752 0 0 1 11.25 16h-6.5a.75.75 0 0 1-.565-1.243c.772-.885 1.192-1.716 1.292-2.757H1.75A1.75 1.75 0 0 1 0 10.25v-7.5C0 1.784.784 1 1.75 1ZM1.75 2.5a.25.25 0 0 0-.25.25v7.5c0 .138.112.25.25.25h12.5a.25.25 0 0 0 .25-.25v-7.5a.25.25 0 0 0-.25-.25ZM9.018 12H6.982a5.72 5.72 0 0 1-.765 2.5h3.566a5.72 5.72 0 0 1-.765-2.5Z"></path>
      ...
      <div class="FormControl-inlineValidation" id="validation-247271c4-a955-423c-a3d1-1d6b95e148f6" hidden="hidden">
  ...
  <div class="Overlay-headerContentWrap">
    ...
    <path d="M3.72 3.72a.75.75 0 0 1 1.06 0L8 6.94l3.22-3.22a.749.749 0 0 1 1.275.326.749.749 0 0 1-.215.734L9.06 8l3.22 3.22a.749.749 0 0 1-.326 1.275.749.749 0 0 1-.734-.215L8 9.06l-3.22 3.22a.751.751 0 0 1-1.042-.018.751.751 0 0 1-.018-1.042L6.94 8 3.72 4.78a.75.75 0 0 1 0-1.06Z"></path>
      ...
      <scrollable-region data-labelled-by="feedback-dialog-title">
        <div data-view-component="true" class="Overlay-body">        <!-- '"` --><!-- </textarea></xmp> --></option></form><form id="code-search-feedback-form" data-turbo="false" action="/search/feedback" accept-charset="UTF-8" method="post"><input type="hidden" name="authenticity_token" value="1DUVOF2NsVYXmffI5FCtvSG6LUcZLKTfvaMUInswqgnYunfQj790jxb0JV-_y5S3JjIGhxn3K8CWqSIEZjepnQ" />
  ...
  <div class="Overlay-headerContentWrap">
    ...
    <path d="M3.72 3.72a.75.75 0 0 1 1.06 0L8 6.94l3.22-3.22a.749.749 0 0 1 1.275.326.749.749 0 0 1-.215.734L9.06 8l3.22 3.22a.749.749 0 0 1-.326 1.275.749.749 0 0 1-.734-.215L8 9.06l-3.22 3.22a.751.751 0 0 1-1.042-.018.751.751 0 0 1-.018-1.042L6.94 8 3.72 4.78a.75.75 0 0 1 0-1.06Z"></path>
      ...
      <scrollable-region data-labelled-by="custom-scopes-dialog-title">
        ...
        <!-- '"` --><!-- </textarea></xmp> --></option></form><form id="custom-scopes-dialog-form" data-turbo="false" action="/search/custom_scopes" accept-charset="UTF-8" method="post"><input type="hidden" name="authenticity_token" value="X_RN9xNhSVWdcNcZkMtC4NjBn3kALnNSu6s5NdQLCMBY4TOvRWmGi_CQGFqD4WzRQ5eck-3bAwHTND_mz2mLnw" />
          ...
          <div class="form-group">
            ...
            <auto-check src="/search/custom_scopes/check_name" required only-validate-on-blur="false">
              <input
                ...
                required
                maxlength="50">
              <input type="hidden" value="io7wiUQGsxGN0bp5DGOwdABatfVwytd84P8O0r9t_nEbwsrEjMhbVSB3GK_7a6nPs7_eradM7D4MToWia-RIOg" data-csrf="true" />
            </auto-check>
          </div>
...
</qbsearch-input>  <input type="hidden" value="xIayC3f13-UWd2xo05rUrbsrxxICnNTeghOt80KiElkPcjVVDqPEyxPxkHLja74niUaqSuYwMnOicttKt8IMNw" data-csrf="true" class="js-data-jump-to-suggestions-path-csrf" />
    ...
    <react-partial-anchor>
      <button id="copilot-chat-header-button" data-target="react-partial-anchor.anchor" data-hotkey="Shift+C" aria-expanded="false" aria-controls="copilot-chat-panel" aria-labelledby="tooltip-bb7e4682-c540-47a5-ab12-d9549734d10e" type="button" disabled="disabled" data-view-component="true" class="Button Button--iconOnly Button--secondary Button--medium AppHeader-button AppHeader-buttonLeft cursor-wait">  <svg aria-hidden="true" height="16" viewBox="0 0 16 16" version="1.1" width="16" data-view-component="true" class="octicon octicon-copilot Button-visual">
    <path d="M7.998 15.035c-4.562 0-7.873-2.914-7.998-3.749V9.338c.085-.628.677-1.686 1.588-2.065.013-.07.024-.143.036-.218.029-.183.06-.384.126-.612-.201-.508-.254-1.084-.254-1.656 0-.87.128-1.769.693-2.484.579-.733 1.494-1.124 2.724-1.261 1.206-.134 2.262.034 2.944.765.05.053.096.108.139.165.044-.057.094-.112.143-.165.682-.731 1.738-.899 2.944-.765 1.23.137 2.145.528 2.724 1.261.566.715.693 1.614.693 2.484 0 .572-.053 1.148-.254 1.656.066.228.098.429.126.612.012.076.024.148.037.218.924.385 1.522 1.471 1.591 2.095v1.872c0 .766-3.351 3.795-8.002 3.795Zm0-1.485c2.28 0 4.584-1.11 5.002-1.433V7.862l-.023-.116c-.49.21-1.075.291-1.727.291-1.146 0-2.059-.327-2.71-.991A3.222 3.222 0 0 1 8 6.303a3.24 3.24 0 0 1-.544.743c-.65.664-1.563.991-2.71.991-.652 0-1.236-.081-1.727-.291l-.023.116v4.255c.419.323 2.722 1.433 5.002 1.433ZM6.762 2.83c-.193-.206-.637-.413-1.682-.297-1.019.113-1.479.404-1.713.7-.247.312-.369.789-.369 1.554 0 .793.129 1.171.308 1.371.162.181.519.379 1.442.379.853 0 1.339-.235 1.638-.54.315-.322.527-.827.617-1.553.117-.935-.037-1.395-.241-1.614Zm4.155-.297c-1.044-.116-1.488.091-1.681.297-.204.219-.359.679-.242 1.614.091.726.303 1.231.618 1.553.299.305.784.54 1.638.54.922 0 1.28-.198 1.442-.379.179-.2.308-.578.308-1.371 0-.765-.123-1.242-.37-1.554-.233-.296-.693-.587-1.713-.7Z"></path><path d="M6.25 9.037a.75.75 0 0 1 .75.75v1.501a.75.75 0 0 1-1.5 0V9.787a.75.75 0 0 1 .75-.75Zm4.25.75v1.501a.75.75 0 0 1-1.5 0V9.787a.75.75 0 0 1 1.5 0Z"></path>
</svg>
</button><tool-tip id="tooltip-bb7e4682-c540-47a5-ab12-d9549734d10e" for="copilot-chat-header-button" popover="manual" data-direction="s" data-type="label" data-view-component="true" class="sr-only position-absolute">Chat with Copilot</tool-tip>
...
<link crossorigin="anonymous" media="all" rel="stylesheet" href="https://github.githubassets.com/assets/copilot-chat.4e64150ee8c92ed63ef0.module.css" />
    ...
    <react-partial-anchor>
      <button id="global-copilot-menu-button" data-target="react-partial-anchor.anchor" aria-expanded="false" aria-labelledby="tooltip-b3aa2e1a-5d85-4ff2-b99d-190a20831f35" type="button" data-view-component="true" class="Button Button--iconOnly Button--secondary Button--medium AppHeader-button AppHeader-buttonRight">  <svg aria-hidden="true" height="16" viewBox="0 0 16 16" version="1.1" width="16" data-view-component="true" class="octicon octicon-triangle-down Button-visual">
    <path d="m4.427 7.427 3.396 3.396a.25.25 0 0 0 .354 0l3.396-3.396A.25.25 0 0 0 11.396 7H4.604a.25.25 0 0 0-.177.427Z"></path>
</svg>
</button><tool-tip id="tooltip-b3aa2e1a-5d85-4ff2-b99d-190a20831f35" for="global-copilot-menu-button" popover="manual" data-direction="s" data-type="label" data-view-component="true" class="sr-only position-absolute">Open Copilot…</tool-tip>
...
</button><tool-tip id="tooltip-7aa784e0-dfa6-4e67-bc04-0d569be120b6" for="global-create-menu-anchor" popover="manual" data-direction="s" data-type="description" data-view-component="true" class="sr-only position-absolute">Create new...</tool-tip>
...
>
  ...
  <div data-target="react-partial.reactRoot"></div>
          ...
          <a href="/issues" data-analytics-event="{&quot;category&quot;:&quot;Global navigation&quot;,&quot;action&quot;:&quot;ISSUES_HEADER&quot;,&quot;label&quot;:null}" id="icon-button-df720b7c-12dd-49ab-adea-a9d14f1c911d" aria-labelledby="tooltip-39333954-a41b-4e86-9d1a-a4d3adb6a338" data-view-component="true" class="Button Button--iconOnly Button--secondary Button--medium AppHeader-button color-fg-muted">  <svg aria-hidden="true" height="16" viewBox="0 0 16 16" version="1.1" width="16" data-view-component="true" class="octicon octicon-issue-opened Button-visual">
    <path d="M8 9.5a1.5 1.5 0 1 0 0-3 1.5 1.5 0 0 0 0 3Z"></path><path d="M8 0a8 8 0 1 1 0 16A8 8 0 0 1 8 0ZM1.5 8a6.5 6.5 0 1 0 13 0 6.5 6.5 0 0 0-13 0Z"></path>
</svg>
</a><tool-tip id="tooltip-39333954-a41b-4e86-9d1a-a4d3adb6a338" for="icon-button-df720b7c-12dd-49ab-adea-a9d14f1c911d" popover="manual" data-direction="s" data-type="label" data-view-component="true" class="sr-only position-absolute">Your issues</tool-tip>

          <a href="/pulls" data-analytics-event="{&quot;category&quot;:&quot;Global navigation&quot;,&quot;action&quot;:&quot;PULL_REQUESTS_HEADER&quot;,&quot;label&quot;:null}" id="icon-button-a419da13-3f9f-4deb-bb09-cb7d33916a2f" aria-labelledby="tooltip-3cf1c74b-1f4e-4af4-8d9e-3db186f14305" data-view-component="true" class="Button Button--iconOnly Button--secondary Button--medium AppHeader-button color-fg-muted">  <svg aria-hidden="true" height="16" viewBox="0 0 16 16" version="1.1" width="16" data-view-component="true" class="octicon octicon-git-pull-request Button-visual">
    <path d="M1.5 3.25a2.25 2.25 0 1 1 3 2.122v5.256a2.251 2.251 0 1 1-1.5 0V5.372A2.25 2.25 0 0 1 1.5 3.25Zm5.677-.177L9.573.677A.25.25 0 0 1 10 .854V2.5h1A2.5 2.5 0 0 1 13.5 5v5.628a2.251 2.251 0 1 1-1.5 0V5a1 1 0 0 0-1-1h-1v1.646a.25.25 0 0 1-.427.177L7.177 3.427a.25.25 0 0 1 0-.354ZM3.75 2.5a.75.75 0 1 0 0 1.5.75.75 0 0 0 0-1.5Zm0 9.5a.75.75 0 1 0 0 1.5.75.75 0 0 0 0-1.5Zm8.25.75a.75.75 0 1 0 1.5 0 .75.75 0 0 0-1.5 0Z"></path>
</svg>
</a><tool-tip id="tooltip-3cf1c74b-1f4e-4af4-8d9e-3db186f14305" for="icon-button-a419da13-3f9f-4deb-bb09-cb7d33916a2f" popover="manual" data-direction="s" data-type="label" data-view-component="true" class="sr-only position-absolute">Your pull requests</tool-tip>

        </div>

        <notification-indicator data-channel="eyJjIjoibm90aWZpY2F0aW9uLWNoYW5nZWQ6MTkwNjUzNjk0IiwidCI6MTc0MTI5NDA4Nn0=--02f2a638c5d7a9e03e80de2490ae3eb390c32d60e80e642d75b2b0d8883bfbb8" data-indicator-mode="none" data-tooltip-global="You have unread notifications" data-tooltip-unavailable="Notifications are unavailable at the moment." data-tooltip-none="You have no unread notifications" data-header-redesign-enabled="true" data-fetch-indicator-src="/notifications/indicator" data-fetch-indicator-enabled="true" data-view-component="true" class="js-socket-channel">
...
<site-header-logged-in-user-menu>
  ...
  <focus-group direction="vertical" mnemonics retain>
    <button id="action-menu-8c21fd58-cfbf-4366-bde9-0393f521006e-button" popovertarget="action-menu-8c21fd58-cfbf-4366-bde9-0393f521006e-overlay" aria-controls="action-menu-8c21fd58-cfbf-4366-bde9-0393f521006e-list" aria-haspopup="true" aria-labelledby="tooltip-b324d6c3-af5e-4953-9751-dcbc0ad7065d" type="button" data-view-component="true" class="Button Button--iconOnly Button--secondary Button--medium UnderlineNav-item">  <svg aria-hidden="true" height="16" viewBox="0 0 16 16" version="1.1" width="16" data-view-component="true" class="octicon octicon-kebab-horizontal Button-visual">
    <path d="M8 9a1.5 1.5 0 1 0 0-3 1.5 1.5 0 0 0 0 3ZM1.5 9a1.5 1.5 0 1 0 0-3 1.5 1.5 0 0 0 0 3Zm13 0a1.5 1.5 0 1 0 0-3 1.5 1.5 0 0 0 0 3Z"></path>
</svg>
</button><tool-tip id="tooltip-b324d6c3-af5e-4953-9751-dcbc0ad7065d" for="action-menu-8c21fd58-cfbf-4366-bde9-0393f521006e-button" popover="manual" data-direction="s" data-type="label" data-view-component="true" class="sr-only position-absolute">Additional navigation options</tool-tip>


<anchored-position data-target="action-menu.overlay" id="action-menu-8c21fd58-cfbf-4366-bde9-0393f521006e-overlay" anchor="action-menu-8c21fd58-cfbf-4366-bde9-0393f521006e-button" align="start" side="outside-bottom" anchor-offset="normal" popover="auto" data-view-component="true">
  <div data-view-component="true" class="Overlay Overlay--size-auto">
    
      <div data-view-component="true" class="Overlay-body Overlay-body--paddingNone">          <action-list>
  <div data-view-component="true">
    <ul aria-labelledby="action-menu-8c21fd58-cfbf-4366-bde9-0393f521006e-button" id="action-menu-8c21fd58-cfbf-4366-bde9-0393f521006e-list" role="menu" data-view-component="true" class="ActionListWrap--inset ActionListWrap">
        <li hidden="hidden" data-menu-item="i0code-tab" data-targets="action-list.items" role="none" data-view-component="true" class="ActionListItem">
    
    
    <a tabindex="-1" id="item-0ce7e99f-2b1b-45c1-98ac-095600e8e79d" href="/32ES/ESP32" role="menuitem" data-view-component="true" class="ActionListContent ActionListContent--visual16">
        <span class="ActionListItem-visual ActionListItem-visual--leading">
          <svg aria-hidden="true" height="16" viewBox="0 0 16 16" version="1.1" width="16" data-view-component="true" class="octicon octicon-code">
    <path d="m11.28 3.22 4.25 4.25a.75.75 0 0 1 0 1.06l-4.25 4.25a.749.749 0 0 1-1.275-.326.749.749 0 0 1 .215-.734L13.94 8l-3.72-3.72a.749.749 0 0 1 .326-1.275.749.749 0 0 1 .734.215Zm-6.56 0a.751.751 0 0 1 1.042.018.751.751 0 0 1 .018 1.042L2.06 8l3.72 3.72a.749.749 0 0 1-.326 1.275.749.749 0 0 1-.734-.215L.47 8.53a.75.75 0 0 1 0-1.06Z"></path>
</svg>
    ...
    <a tabindex="-1" id="item-3b7593d9-3c9f-463e-b22c-c96a2a27f20e" href="/32ES/ESP32/issues" role="menuitem" data-view-component="true" class="ActionListContent ActionListContent--visual16">
        <span class="ActionListItem-visual ActionListItem-visual--leading">
          <svg aria-hidden="true" height="16" viewBox="0 0 16 16" version="1.1" width="16" data-view-component="true" class="octicon octicon-issue-opened">
    <path d="M8 9.5a1.5 1.5 0 1 0 0-3 1.5 1.5 0 0 0 0 3Z"></path><path d="M8 0a8 8 0 1 1 0 16A8 8 0 0 1 8 0ZM1.5 8a6.5 6.5 0 1 0 13 0 6.5 6.5 0 0 0-13 0Z"></path>
</svg>
    ...
    <a tabindex="-1" id="item-8a11cd1c-5948-4a10-b03f-1d0d93e394f0" href="/32ES/ESP32/pulls" role="menuitem" data-view-component="true" class="ActionListContent ActionListContent--visual16">
        <span class="ActionListItem-visual ActionListItem-visual--leading">
          <svg aria-hidden="true" height="16" viewBox="0 0 16 16" version="1.1" width="16" data-view-component="true" class="octicon octicon-git-pull-request">
    <path d="M1.5 3.25a2.25 2.25 0 1 1 3 2.122v5.256a2.251 2.251 0 1 1-1.5 0V5.372A2.25 2.25 0 0 1 1.5 3.25Zm5.677-.177L9.573.677A.25.25 0 0 1 10 .854V2.5h1A2.5 2.5 0 0 1 13.5 5v5.628a2.251 2.251 0 1 1-1.5 0V5a1 1 0 0 0-1-1h-1v1.646a.25.25 0 0 1-.427.177L7.177 3.427a.25.25 0 0 1 0-.354ZM3.75 2.5a.75.75 0 1 0 0 1.5.75.75 0 0 0 0-1.5Zm0 9.5a.75.75 0 1 0 0 1.5.75.75 0 0 0 0-1.5Zm8.25.75a.75.75 0 1 0 1.5 0 .75.75 0 0 0-1.5 0Z"></path>
</svg>
    ...
    <a tabindex="-1" id="item-80d63ddf-4818-4cbd-8d27-6ce3e8afa580" href="/32ES/ESP32/actions" role="menuitem" data-view-component="true" class="ActionListContent ActionListContent--visual16">
        <span class="ActionListItem-visual ActionListItem-visual--leading">
          <svg aria-hidden="true" height="16" viewBox="0 0 16 16" version="1.1" width="16" data-view-component="true" class="octicon octicon-play">
    <path d="M8 0a8 8 0 1 1 0 16A8 8 0 0 1 8 0ZM1.5 8a6.5 6.5 0 1 0 13 0 6.5 6.5 0 0 0-13 0Zm4.879-2.773 4.264 2.559a.25.25 0 0 1 0 .428l-4.264 2.559A.25.25 0 0 1 6 10.559V5.442a.25.25 0 0 1 .379-.215Z"></path>
</svg>
    ...
    <a tabindex="-1" id="item-4493e13f-b246-4d1c-999f-dd5ce9c8e689" href="/32ES/ESP32/projects" role="menuitem" data-view-component="true" class="ActionListContent ActionListContent--visual16">
        <span class="ActionListItem-visual ActionListItem-visual--leading">
          <svg aria-hidden="true" height="16" viewBox="0 0 16 16" version="1.1" width="16" data-view-component="true" class="octicon octicon-table">
    <path d="M0 1.75C0 .784.784 0 1.75 0h12.5C15.216 0 16 .784 16 1.75v12.5A1.75 1.75 0 0 1 14.25 16H1.75A1.75 1.75 0 0 1 0 14.25ZM6.5 6.5v8h7.75a.25.25 0 0 0 .25-.25V6.5Zm8-1.5V1.75a.25.25 0 0 0-.25-.25H6.5V5Zm-13 1.5v7.75c0 .138.112.25.25.25H5v-8ZM5 5V1.5H1.75a.25.25 0 0 0-.25.25V5Z"></path>
</svg>
    ...
    <a tabindex="-1" id="item-7f02f3e6-0eec-4ed9-9155-829e8184600b" href="/32ES/ESP32/wiki" role="menuitem" data-view-component="true" class="ActionListContent ActionListContent--visual16">
        <span class="ActionListItem-visual ActionListItem-visual--leading">
          <svg aria-hidden="true" height="16" viewBox="0 0 16 16" version="1.1" width="16" data-view-component="true" class="octicon octicon-book">
    <path d="M0 1.75A.75.75 0 0 1 .75 1h4.253c1.227 0 2.317.59 3 1.501A3.743 3.743 0 0 1 11.006 1h4.245a.75.75 0 0 1 .75.75v10.5a.75.75 0 0 1-.75.75h-4.507a2.25 2.25 0 0 0-1.591.659l-.622.621a.75.75 0 0 1-1.06 0l-.622-.621A2.25 2.25 0 0 0 5.258 13H.75a.75.75 0 0 1-.75-.75Zm7.251 10.324.004-5.073-.002-2.253A2.25 2.25 0 0 0 5.003 2.5H1.5v9h3.757a3.75 3.75 0 0 1 1.994.574ZM8.755 4.75l-.004 7.322a3.752 3.752 0 0 1 1.992-.572H14.5v-9h-3.495a2.25 2.25 0 0 0-2.25 2.25Z"></path>
</svg>
    ...
    <a tabindex="-1" id="item-fd47373c-1bca-4c23-87f5-8fdd1cdf2edf" href="/32ES/ESP32/security" role="menuitem" data-view-component="true" class="ActionListContent ActionListContent--visual16">
        <span class="ActionListItem-visual ActionListItem-visual--leading">
    ...
    <a tabindex="-1" id="item-26d1eb29-7ffe-406a-9c2c-ffa599ccbc91" href="/32ES/ESP32/pulse" role="menuitem" data-view-component="true" class="ActionListContent ActionListContent--visual16">
        <span class="ActionListItem-visual ActionListItem-visual--leading">
    ...
    <a tabindex="-1" id="item-9256df26-6d3e-479b-b8e5-1782b63497ca" href="/32ES/ESP32/settings" role="menuitem" data-view-component="true" class="ActionListContent ActionListContent--visual16">
        <span class="ActionListItem-visual ActionListItem-visual--leading">
    ...
    <button id="icon-button-10d0142d-b506-4500-a04c-e681a1b59445" aria-labelledby="tooltip-72129e02-aff1-4d8d-a67a-e629a05d76d0" type="button" data-view-component="true" class="Button Button--iconOnly Button--invisible Button--medium flash-close js-flash-close">  <svg aria-hidden="true" height="16" viewBox="0 0 16 16" version="1.1" width="16" data-view-component="true" class="octicon octicon-x Button-visual">
    <path d="M3.72 3.72a.75.75 0 0 1 1.06 0L8 6.94l3.22-3.22a.749.749 0 0 1 1.275.326.749.749 0 0 1-.215.734L9.06 8l3.22 3.22a.749.749 0 0 1-.326 1.275.749.749 0 0 1-.734-.215L8 9.06l-3.22 3.22a.751.751 0 0 1-1.042-.018.751.751 0 0 1-.018-1.042L6.94 8 3.72 4.78a.75.75 0 0 1 0-1.06Z"></path>
</svg>
</button><tool-tip id="tooltip-72129e02-aff1-4d8d-a67a-e629a05d76d0" for="icon-button-10d0142d-b506-4500-a04c-e681a1b59445" popover="manual" data-direction="s" data-type="label" data-view-component="true" class="sr-only position-absolute">Dismiss alert</tool-tip>
...
<div class="flash flash-full   {{ className }}">
  ...
  <notification-shelf-watcher data-base-url="https://github.com/notifications/beta/shelf" data-channel="eyJjIjoibm90aWZpY2F0aW9uLWNoYW5nZWQ6MTkwNjUzNjk0IiwidCI6MTc0MTI5NDA4Nn0=--02f2a638c5d7a9e03e80de2490ae3eb390c32d60e80e642d75b2b0d8883bfbb8" data-view-component="true" class="js-socket-channel"></notification-shelf-watcher>
...
<react-app
  ...
  initial-path="/32ES/ESP32/blob/main/14_Buzzer.ino"
...
>
  ...
  <script type="application/json" data-target="react-app.embeddedData">{"payload":{"allShortcutsEnabled":true,"fileTree":{"":{"items":[{"name":"10_RGB.ino","path":"10_RGB.ino","contentType":"file"},{"name":"11_Push_button_LED.ino","path":"11_Push_button_LED.ino","contentType":"file"},{"name":"12_Analoginput.ino","path":"12_Analoginput.ino","contentType":"file"},{"name":"13_Dimmer.ino","path":"13_Dimmer.ino","contentType":"file"},{"name":"14_Buzzer.ino","path":"14_Buzzer.ino","contentType":"file"},{"name":"15_LDR.ino","path":"15_LDR.ino","contentType":"file"},{"name":"16_IR.ino","path":"16_IR.ino","contentType":"file"},{"name":"17_DHT11_OLED.ino","path":"17_DHT11_OLED.ino","contentType":"file"},{"name":"19_Relay.ino","path":"19_Relay.ino","contentType":"file"},{"name":"20_touch.ino","path":"20_touch.ino","contentType":"file"},{"name":"21_WiFi_LED.ino","path":"21_WiFi_LED.ino","contentType":"file"},{"name":"22_WiFi_DHT11.ino","path":"22_WiFi_DHT11.ino","contentType":"file"},{"name":"23_Firebase_LED.ino","path":"23_Firebase_LED.ino","contentType":"file"},{"name":"24_Firebase_LED_count.ino","path":"24_Firebase_LED_count.ino","contentType":"file"},{"name":"5_Serial_first_time.ino","path":"5_Serial_first_time.ino","contentType":"file"},{"name":"7_Serial_monitor_calc.ino","path":"7_Serial_monitor_calc.ino","contentType":"file"},{"name":"8_LED_blink_onboard.ino","path":"8_LED_blink_onboard.ino","contentType":"file"},{"name":"9_LED_blink_external.ino","path":"9_LED_blink_external.ino","contentType":"file"},{"name":"Logo ESP32.png","path":"Logo ESP32.png","contentType":"file"}],"totalCount":19}},"fileTreeProcessingTime":6.0844879999999995,"foldersToFetch":[],"repo":{"id":905597089,"defaultBranch":"main","name":"ESP32","ownerLogin":"32ES","currentUserCanPush":true,"isFork":false,"isEmpty":false,"createdAt":"2024-12-19T08:37:52.000+02:00","ownerAvatar":"https://avatars.githubusercontent.com/u/190653694?v=4","public":true,"private":false,"isOrgOwned":false},"codeLineWrapEnabled":false,"symbolsExpanded":false,"treeExpanded":true,"refInfo":{"name":"main","listCacheKey":"v0:1734590783.0","canEdit":true,"refType":"branch","currentOid":"d3729cb5972014ca5396ec65e8f4fa21b8187e27"},"path":"14_Buzzer.ino","currentUser":{"id":190653694,"login":"32ES","userEmail":"electronica4us@gmail.com"},"blob":{"rawLines":["// Include necessary libraries","// (No additional libraries are required for basic GPIO control in Arduino IDE)","","// Define the GPIO pin connected to the passive buzzer","#define BUZZER_PIN 18","","void setup() {","  // Initialize the serial communication for debugging (optional)","  Serial.begin(115200);","","  // Set the buzzer pin as an output","  pinMode(BUZZER_PIN, OUTPUT);","}","","void loop() {","  // Generate a tone by toggling the GPIO pin","  for (int i = 0; i \u003c 1000; i++) { // Adjust the loop count for tone duration","    digitalWrite(BUZZER_PIN, HIGH); // Set the pin HIGH","    delayMicroseconds(500); // Adjust the delay for tone frequency (e.g., 500us for 1kHz)","    digitalWrite(BUZZER_PIN, LOW); // Set the pin LOW","    delayMicroseconds(500); // Maintain the same delay for consistency","  }","  Serial.println(\"Buzzer played tone\"); // Debug message","","  // Wait for 1 second (1000 milliseconds) before playing the tone again","  delay(1000);","}","","","/*","// Include necessary libraries","// (No additional libraries are required for basic GPIO control in Arduino IDE)","","// Define the GPIO pin connected to the active buzzer","#define BUZZER_PIN 18","","void setup() {","  // Initialize the serial communication for debugging (optional)","  Serial.begin(115200);","","  // Set the buzzer pin as an output","  pinMode(BUZZER_PIN, OUTPUT);","}","","void loop() {","  // Turn the buzzer on by setting the GPIO pin HIGH","  digitalWrite(BUZZER_PIN, HIGH);","  Serial.println(\"Buzzer ON\"); // Debug message","","  // Wait for 1 second (1000 milliseconds)","  delay(1000);","","  // Turn the buzzer off by setting the GPIO pin LOW","  digitalWrite(BUZZER_PIN, LOW);","  Serial.println(\"Buzzer OFF\"); // Debug message","","  // Wait for 1 second (1000 milliseconds)","  delay(1000);","}","*/"],"stylingDirectives":null,"colorizedLines":["\u003cspan class=\"pl-c\"\u003e\u003cspan class=\"pl-c\"\u003e//\u003c/span\u003e Include necessary libraries\u003c/span\u003e","\u003cspan class=\"pl-c\"\u003e\u003cspan class=\"pl-c\"\u003e//\u003c/span\u003e (No additional libraries are required for basic GPIO control in Arduino IDE)\u003c/span\u003e","","\u003cspan class=\"pl-c\"\u003e\u003cspan class=\"pl-c\"\u003e//\u003c/span\u003e Define the GPIO pin connected to the passive buzzer\u003c/span\u003e","#\u003cspan class=\"pl-k\"\u003edefine\u003c/span\u003e \u003cspan class=\"pl-en\"\u003eBUZZER_PIN\u003c/span\u003e \u003cspan class=\"pl-c1\"\u003e18\u003c/span\u003e","","\u003cspan class=\"pl-k\"\u003evoid\u003c/span\u003e \u003cspan class=\"pl-en\"\u003esetup\u003c/span\u003e() {","  \u003cspan class=\"pl-c\"\u003e\u003cspan class=\"pl-c\"\u003e//\u003c/span\u003e Initialize the serial communication for debugging (optional)\u003c/span\u003e","  Serial.\u003cspan class=\"pl-c1\"\u003ebegin\u003c/span\u003e(\u003cspan class=\"pl-c1\"\u003e115200\u003c/span\u003e);","","  \u003cspan class=\"pl-c\"\u003e\u003cspan class=\"pl-c\"\u003e//\u003c/span\u003e Set the buzzer pin as an output\u003c/span\u003e","  \u003cspan class=\"pl-c1\"\u003epinMode\u003c/span\u003e(BUZZER_PIN, OUTPUT);","}","","\u003cspan class=\"pl-k\"\u003evoid\u003c/span\u003e \u003cspan class=\"pl-en\"\u003eloop\u003c/span\u003e() {","  \u003cspan class=\"pl-c\"\u003e\u003cspan class=\"pl-c\"\u003e//\u003c/span\u003e Generate a tone by toggling the GPIO pin\u003c/span\u003e","  \u003cspan class=\"pl-k\"\u003efor\u003c/span\u003e (\u003cspan class=\"pl-k\"\u003eint\u003c/span\u003e i = \u003cspan class=\"pl-c1\"\u003e0\u003c/span\u003e; i \u0026lt; \u003cspan class=\"pl-c1\"\u003e1000\u003c/span\u003e; i++) { \u003cspan class=\"pl-c\"\u003e\u003cspan class=\"pl-c\"\u003e//\u003c/span\u003e Adjust the loop count for tone duration\u003c/span\u003e","    \u003cspan class=\"pl-c1\"\u003edigitalWrite\u003c/span\u003e(BUZZER_PIN, HIGH); \u003cspan class=\"pl-c\"\u003e\u003cspan class=\"pl-c\"\u003e//\u003c/span\u003e Set the pin HIGH\u003c/span\u003e","    \u003cspan class=\"pl-c1\"\u003edelayMicroseconds\u003c/span\u003e(\u003cspan class=\"pl-c1\"\u003e500\u003c/span\u003e); \u003cspan class=\"pl-c\"\u003e\u003cspan class=\"pl-c\"\u003e//\u003c/span\u003e Adjust the delay for tone frequency (e.g., 500us for 1kHz)\u003c/span\u003e","    \u003cspan class=\"pl-c1\"\u003edigitalWrite\u003c/span\u003e(BUZZER_PIN, LOW); \u003cspan class=\"pl-c\"\u003e\u003cspan class=\"pl-c\"\u003e//\u003c/span\u003e Set the pin LOW\u003c/span\u003e","    \u003cspan class=\"pl-c1\"\u003edelayMicroseconds\u003c/span\u003e(\u003cspan class=\"pl-c1\"\u003e500\u003c/span\u003e); \u003cspan class=\"pl-c\"\u003e\u003cspan class=\"pl-c\"\u003e//\u003c/span\u003e Maintain the same delay for consistency\u003c/span\u003e","  }","  Serial.\u003cspan class=\"pl-c1\"\u003eprintln\u003c/span\u003e(\u003cspan class=\"pl-s\"\u003e\u003cspan class=\"pl-pds\"\u003e\u0026quot;\u003c/span\u003eBuzzer played tone\u003cspan class=\"pl-pds\"\u003e\u0026quot;\u003c/span\u003e\u003c/span\u003e); \u003cspan class=\"pl-c\"\u003e\u003cspan class=\"pl-c\"\u003e//\u003c/span\u003e Debug message\u003c/span\u003e","","  \u003cspan class=\"pl-c\"\u003e\u003cspan class=\"pl-c\"\u003e//\u003c/span\u003e Wait for 1 second (1000 milliseconds) before playing the tone again\u003c/span\u003e","  \u003cspan class=\"pl-c1\"\u003edelay\u003c/span\u003e(\u003cspan class=\"pl-c1\"\u003e1000\u003c/span\u003e);","}","","","\u003cspan class=\"pl-c\"\u003e\u003cspan class=\"pl-c\"\u003e/*\u003c/span\u003e\u003c/span\u003e","\u003cspan class=\"pl-c\"\u003e// Include necessary libraries\u003c/span\u003e","\u003cspan class=\"pl-c\"\u003e// (No additional libraries are required for basic GPIO control in Arduino IDE)\u003c/span\u003e","\u003cspan class=\"pl-c\"\u003e\u003c/span\u003e","\u003cspan class=\"pl-c\"\u003e// Define the GPIO pin connected to the active buzzer\u003c/span\u003e","\u003cspan class=\"pl-c\"\u003e#define BUZZER_PIN 18\u003c/span\u003e","\u003cspan class=\"pl-c\"\u003e\u003c/span\u003e","\u003cspan class=\"pl-c\"\u003evoid setup() {\u003c/span\u003e","\u003cspan class=\"pl-c\"\u003e  // Initialize the serial communication for debugging (optional)\u003c/span\u003e","\u003cspan class=\"pl-c\"\u003e  Serial.begin(115200);\u003c/span\u003e","\u003cspan class=\"pl-c\"\u003e\u003c/span\u003e","\u003cspan class=\"pl-c\"\u003e  // Set the buzzer pin as an output\u003c/span\u003e","\u003cspan class=\"pl-c\"\u003e  pinMode(BUZZER_PIN, OUTPUT);\u003c/span\u003e","\u003cspan class=\"pl-c\"\u003e}\u003c/span\u003e","\u003cspan class=\"pl-c\"\u003e\u003c/span\u003e","\u003cspan class=\"pl-c\"\u003evoid loop() {\u003c/span\u003e","\u003cspan class=\"pl-c\"\u003e  // Turn the buzzer on by setting the GPIO pin HIGH\u003c/span\u003e","\u003cspan class=\"pl-c\"\u003e  digitalWrite(BUZZER_PIN, HIGH);\u003c/span\u003e","\u003cspan class=\"pl-c\"\u003e  Serial.println(\u0026quot;Buzzer ON\u0026quot;); // Debug message\u003c/span\u003e","\u003cspan class=\"pl-c\"\u003e\u003c/span\u003e","\u003cspan class=\"pl-c\"\u003e  // Wait for 1 second (1000 milliseconds)\u003c/span\u003e","\u003cspan class=\"pl-c\"\u003e  delay(1000);\u003c/span\u003e","\u003cspan class=\"pl-c\"\u003e\u003c/span\u003e","\u003cspan class=\"pl-c\"\u003e  // Turn the buzzer off by setting the GPIO pin LOW\u003c/span\u003e","\u003cspan class=\"pl-c\"\u003e  digitalWrite(BUZZER_PIN, LOW);\u003c/span\u003e","\u003cspan class=\"pl-c\"\u003e  Serial.println(\u0026quot;Buzzer OFF\u0026quot;); // Debug message\u003c/span\u003e","\u003cspan class=\"pl-c\"\u003e\u003c/span\u003e","\u003cspan class=\"pl-c\"\u003e  // Wait for 1 second (1000 milliseconds)\u003c/span\u003e","\u003cspan class=\"pl-c\"\u003e  delay(1000);\u003c/span\u003e","\u003cspan class=\"pl-c\"\u003e}\u003c/span\u003e","\u003cspan class=\"pl-c\"\u003e\u003cspan class=\"pl-c\"\u003e*/\u003c/span\u003e\u003c/span\u003e"],"csv":null,"csvError":null,"dependabotInfo":{"showConfigurationBanner":false,"configFilePath":null,"networkDependabotPath":"/32ES/ESP32/network/updates","dismissConfigurationNoticePath":"/settings/dismiss-notice/dependabot_configuration_notice","configurationNoticeDismissed":false},"displayName":"14_Buzzer.ino","displayUrl":"https://github.com/32ES/ESP32/blob/main/14_Buzzer.ino?raw=true","headerInfo":{"blobSize":"1.67 KB","deleteTooltip":"Delete this file","editTooltip":"Edit this file","ghDesktopPath":"https://desktop.github.com","isGitLfs":false,"onBranch":true,"shortPath":"8fcef1e","siteNavLoginPath":"/login?return_to=https%3A%2F%2Fgithub.com%2F32ES%2FESP32%2Fblob%2Fmain%2F14_Buzzer.ino","isCSV":false,"isRichtext":false,"toc":null,"lineInfo":{"truncatedLoc":"60","truncatedSloc":"46"},"mode":"file"},"image":false,"isCodeownersFile":null,"isPlain":false,"isValidLegacyIssueTemplate":false,"issueTemplate":null,"discussionTemplate":null,"language":"C++","languageID":43,"large":false,"planSupportInfo":{"repoIsFork":null,"repoOwnedByCurrentUser":null,"requestFullPath":"/32ES/ESP32/blob/main/14_Buzzer.ino","showFreeOrgGatedFeatureMessage":null,"showPlanSupportBanner":null,"upgradeDataAttributes":null,"upgradePath":null},"publishBannersInfo":{"dismissActionNoticePath":"/settings/dismiss-notice/publish_action_from_dockerfile","releasePath":"/32ES/ESP32/releases/new?marketplace=true","showPublishActionBanner":false},"rawBlobUrl":"https://github.com/32ES/ESP32/raw/refs/heads/main/14_Buzzer.ino","renderImageOrRaw":false,"richText":null,"renderedFileInfo":null,"shortPath":null,"symbolsEnabled":true,"tabSize":8,"topBannersInfo":{"overridingGlobalFundingFile":false,"globalPreferredFundingPath":null,"showInvalidCitationWarning":false,"citationHelpUrl":"https://docs.github.com/github/creating-cloning-and-archiving-repositories/creating-a-repository-on-github/about-citation-files","actionsOnboardingTip":null},"truncated":false,"viewable":true,"workflowRedirectUrl":null,"symbols":{"timed_out":false,"not_analyzed":false,"symbols":[{"name":"setup","kind":"function","ident_start":195,"ident_end":200,"extent_start":190,"extent_end":365,"fully_qualified_name":"setup","ident_utf16":{"start":{"line_number":6,"utf16_col":5},"end":{"line_number":6,"utf16_col":10}},"extent_utf16":{"start":{"line_number":6,"utf16_col":0},"end":{"line_number":12,"utf16_col":1}}},{"name":"loop","kind":"function","ident_start":372,"ident_end":376,"extent_start":367,"extent_end":927,"fully_qualified_name":"loop","ident_utf16":{"start":{"line_number":14,"utf16_col":5},"end":{"line_number":14,"utf16_col":9}},"extent_utf16":{"start":{"line_number":14,"utf16_col":0},"end":{"line_number":26,"utf16_col":1}}}]}},"copilotInfo":{"documentationUrl":"https://docs.github.com/copilot/overview-of-github-copilot/about-github-copilot-for-individuals","notices":{"codeViewPopover":{"dismissed":false,"dismissPath":"/settings/dismiss-notice/code_view_copilot_popover"}},"userAccess":{"hasSubscriptionEnded":false,"orgHasCFBAccess":false,"userHasCFIAccess":false,"userHasOrgs":false,"userIsOrgAdmin":false,"userIsOrgMember":false,"business":null,"featureRequestInfo":null}},"copilotAccessAllowed":false,"modelsAccessAllowed":false,"csrf_tokens":{"/32ES/ESP32/branches":{"post":"hzIE-Y_8ZkXIARUstWomSgPUyYWTUBVmSLzaDOvHcENo-VGi0maRrL6HXjBSXKSyQ1SXh0f4jevqxGwMSdkbCQ"},"/repos/preferences":{"post":"9pDkMqwmkbEApi6xcUnQhI2qY_EvMiQGpKdRUF5ZqlueBoFCgj8LaVWkkKfOLVAnYwXccezM0qbxFJx-3VEmNw"}}},"title":"ESP32/14_Buzzer.ino at main · 32ES/ESP32","appPayload":{"helpUrl":"https://docs.github.com","findFileWorkerPath":"/assets-cdn/worker/find-file-worker-7d7eb7c71814.js","findInFileWorkerPath":"/assets-cdn/worker/find-in-file-worker-96e76d5fdb2c.js","githubDevUrl":"https://github.dev/","enabled_features":{"code_nav_ui_events":false,"overview_shared_code_dropdown_button":false,"react_blob_overlay":true,"copilot_conversational_ux_embedding_update":false,"copilot_smell_icebreaker_ux":true,"accessible_code_button":true}}}</script>
...
<div id="LC15" class="react-code-text react-code-line-contents-no-virtualization react-file-line html-div "><span class="pl-k">void</span> <span class="pl-en">loop</span>() {</div>
<div id="LC16" class="react-code-text react-code-line-contents-no-virtualization react-file-line html-div child-of-line-14 ">  <span class="pl-c"><span class="pl-c">//</span> Generate a tone by toggling the GPIO pin</span></div>
<div id="LC17" class="react-code-text react-code-line-contents-no-virtualization react-file-line html-div child-of-line-14 ">  <span class="pl-k">for</span> (<span class="pl-k">int</span> i = <span class="pl-c1">0</span>; i &lt; <span class="pl-c1">1000</span>; i++) { <span class="pl-c"><span class="pl-c">//</span> Adjust the loop count for tone duration</span></div>
<div id="LC18" class="react-code-text react-code-line-contents-no-virtualization react-file-line html-div child-of-line-14 ">    <span class="pl-c1">digitalWrite</span>(BUZZER_PIN, HIGH); <span class="pl-c"><span class="pl-c">//</span> Set the pin HIGH</span></div>
<div id="LC19" class="react-code-text react-code-line-contents-no-virtualization react-file-line html-div child-of-line-14 ">    <span class="pl-c1">delayMicroseconds</span>(<span class="pl-c1">500</span>); <span class="pl-c"><span class="pl-c">//</span> Adjust the delay for tone frequency (e.g., 500us for 1kHz)</span></div>
<div id="LC20" class="react-code-text react-code-line-contents-no-virtualization react-file-line html-div child-of-line-14 ">    <span class="pl-c1">digitalWrite</span>(BUZZER_PIN, LOW); <span class="pl-c"><span class="pl-c">//</span> Set the pin LOW</span></div>
<div id="LC21" class="react-code-text react-code-line-contents-no-virtualization react-file-line html-div child-of-line-14 ">    <span class="pl-c1">delayMicroseconds</span>(<span class="pl-c1">500</span>); <span class="pl-c"><span class="pl-c">//</span> Maintain the same delay for consistency</span></div>
<div id="LC22" class="react-code-text react-code-line-contents-no-virtualization react-file-line html-div child-of-line-14 ">  }</div>
<div id="LC23" class="react-code-text react-code-line-contents-no-virtualization react-file-line html-div child-of-line-14 ">  Serial.<span class="pl-c1">println</span>(<span class="pl-s"><span class="pl-pds">&quot;</span>Buzzer played tone<span class="pl-pds">&quot;</span></span>); <span class="pl-c"><span class="pl-c">//</span> Debug message</span></div>
<div id="LC24" class="react-code-text react-code-line-contents-no-virtualization react-file-line html-div child-of-line-14 ">
</div>
<div id="LC25" class="react-code-text react-code-line-contents-no-virtualization react-file-line html-div child-of-line-14 ">  <span class="pl-c"><span class="pl-c">//</span> Wait for 1 second (1000 milliseconds) before playing the tone again</span></div>
<div id="LC26" class="react-code-text react-code-line-contents-no-virtualization react-file-line html-div child-of-line-14 ">  <span class="pl-c1">delay</span>(<span class="pl-c1">1000</span>);</div>
...
<div id="LC31" class="react-code-text react-code-line-contents-no-virtualization react-file-line html-div "><span class="pl-c">// Include necessary libraries</span></div>
<div id="LC32" class="react-code-text react-code-line-contents-no-virtualization react-file-line html-div "><span class="pl-c">// (No additional libraries are required for basic GPIO control in Arduino IDE)</span></div>
...
<div id="LC34" class="react-code-text react-code-line-contents-no-virtualization react-file-line html-div "><span class="pl-c">// Define the GPIO pin connected to the active buzzer</span></div>
<div id="LC35" class="react-code-text react-code-line-contents-no-virtualization react-file-line html-div "><span class="pl-c">#define BUZZER_PIN 18</span></div>
...
<div id="LC37" class="react-code-text react-code-line-contents-no-virtualization react-file-line html-div "><span class="pl-c">void setup() {</span></div>
<div id="LC38" class="react-code-text react-code-line-contents-no-virtualization react-file-line html-div "><span class="pl-c">  // Initialize the serial communication for debugging (optional)</span></div>
<div id="LC39" class="react-code-text react-code-line-contents-no-virtualization react-file-line html-div "><span class="pl-c">  Serial.begin(115200);</span></div>
...
<div id="LC41" class="react-code-text react-code-line-contents-no-virtualization react-file-line html-div "><span class="pl-c">  // Set the buzzer pin as an output</span></div>
<div id="LC42" class="react-code-text react-code-line-contents-no-virtualization react-file-line html-div "><span class="pl-c">  pinMode(BUZZER_PIN, OUTPUT);</span></div>
...
<div id="LC45" class="react-code-text react-code-line-contents-no-virtualization react-file-line html-div "><span class="pl-c">void loop() {</span></div>
<div id="LC46" class="react-code-text react-code-line-contents-no-virtualization react-file-line html-div "><span class="pl-c">  // Turn the buzzer on by setting the GPIO pin HIGH</span></div>
<div id="LC47" class="react-code-text react-code-line-contents-no-virtualization react-file-line html-div "><span class="pl-c">  digitalWrite(BUZZER_PIN, HIGH);</span></div>
<div id="LC48" class="react-code-text react-code-line-contents-no-virtualization react-file-line html-div "><span class="pl-c">  Serial.println(&quot;Buzzer ON&quot;); // Debug message</span></div>
...
<div id="LC50" class="react-code-text react-code-line-contents-no-virtualization react-file-line html-div "><span class="pl-c">  // Wait for 1 second (1000 milliseconds)</span></div>
<div id="LC51" class="react-code-text react-code-line-contents-no-virtualization react-file-line html-div "><span class="pl-c">  delay(1000);</span></div>
...
<div id="LC53" class="react-code-text react-code-line-contents-no-virtualization react-file-line html-div "><span class="pl-c">  // Turn the buzzer off by setting the GPIO pin LOW</span></div>
<div id="LC54" class="react-code-text react-code-line-contents-no-virtualization react-file-line html-div "><span class="pl-c">  digitalWrite(BUZZER_PIN, LOW);</span></div>
<div id="LC55" class="react-code-text react-code-line-contents-no-virtualization react-file-line html-div "><span class="pl-c">  Serial.println(&quot;Buzzer OFF&quot;); // Debug message</span></div>
...
<div id="LC57" class="react-code-text react-code-line-contents-no-virtualization react-file-line html-div "><span class="pl-c">  // Wait for 1 second (1000 milliseconds)</span></div>
<div id="LC58" class="react-code-text react-code-line-contents-no-virtualization react-file-line html-div "><span class="pl-c">  delay(1000);</span></div>
...
<div id="LC60" class="react-code-text react-code-line-contents-no-virtualization react-file-line html-div "><span class="pl-c"><span class="pl-c">*/</span></span></div></div></div></div></div><div id="copilot-button-container"></div></div><div id="highlighted-line-menu-container"></div></div></div><button hidden="" data-testid="hotkey-button" data-hotkey-scope="read-only-cursor-text-area"></button><button hidden=""></button></section></div></div></div> <!-- --> <!-- --> </div></div></div><div class="Box-sc-g0xbh4-0"></div></div></div></div></div><div id="find-result-marks-container" class="Box-sc-g0xbh4-0 cCoXib"></div><button hidden="" data-testid="" data-hotkey-scope="read-only-cursor-text-area"></button><button hidden=""></button></div> <!-- --> <!-- --> <script type="application/json" id="__PRIMER_DATA_:R0:__">{"resolvedServerColorMode":"day"}</script></div>
</react-app>
</turbo-frame>
